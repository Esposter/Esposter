...
- [x] **Audio messages** — record and send audio via MediaRecorder; stored in Azure Blob
...
- [x] **Call** — Discord-style persistent per-room drop-in audio; WebRTC mesh for small groups; full router test suite covers join/leave/mute/signal/subscribe flows; STUN hardcoded (`stun.l.google.com:19302`); see [`call.md`](../specs/call.md)
