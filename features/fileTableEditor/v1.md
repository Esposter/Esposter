...
- [ ] **Inline cell editing** ⚡ — click a cell directly in the data table to edit it in place; removes the friction of opening a dialog for every edit; expected behaviour for spreadsheet users
