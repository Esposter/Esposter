...
- [x] **Computed columns** — define a transformation that generates a read-only column from a source column; see [`../specs/computed-columns/overview.md`](../specs/computed-columns/overview.md)
