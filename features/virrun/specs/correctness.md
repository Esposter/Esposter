...
| CI gate enforcement                                          | differential corpus hard-fails the CI coverage shards; speed tracked by CodSpeed + the committed `*.bench.md` offline diff (a hard wall-clock gate is out of scope → [out-of-scope/ci-walltime-gate.md](../out-of-scope/ci-walltime-gate.md))                                                                             | realized |
