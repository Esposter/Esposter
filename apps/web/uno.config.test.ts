...
describe("unoConfig", () => {
  ...
  test("each design style's tokens", async () => {
    ...
    expect(getLayer("theme")).toMatchInlineSnapshot(`
      ...
      @layer uno-theme{
      [data-ui-style="standard"]{--ui-block-opacity:0;--ui-border-width:0.0625rem;--ui-container-radius:calc(var(--ui-step) * 2);--ui-control-radius:var(--ui-step);--ui-field-shadow:inset 0 calc(var(--ui-border-width) * -1) 0 0 var(--ui-muted);--ui-focus-width:calc(var(--ui-step) / 2);--ui-font-body:Inter, ui-sans-serif, system-ui, sans-serif;--ui-font-heading:Inter, ui-sans-serif, system-ui, sans-serif;--ui-font-mono:"JetBrains Mono", ui-monospace, monospace;--ui-frame-shadow:none;--ui-heading-color:var(--ui-text);--ui-hover-filter:none;--ui-hover-overlay:linear-gradient(color-mix(in srgb, currentColor 8%, transparent) 0 0);--ui-indicator-width:calc(var(--ui-border-width) * 2);--ui-lifted-shadow:0 0 0 var(--ui-border-width) color-mix(in srgb, var(--ui-text) 8%, transparent), 0 calc(var(--ui-step) * 3) calc(var(--ui-step) * 10) rgb(0 0 0 / 0.24);--ui-line-fill:var(--ui-accent);--ui-line-snap:0.0625rem;--ui-pill-radius:calc(infinity * 1rem);--ui-pressed-overlay:linear-gradient(color-mix(in srgb, currentColor 12%, transparent) 0 0);--ui-raised-background:color-mix(in srgb, var(--ui-accent) 12%, transparent);--ui-raised-color:var(--ui-accent);--ui-raised-shadow:none;--ui-scrim:var(--ui-background);--ui-sunk-background:color-mix(in srgb, var(--ui-text) 6%, transparent);--ui-sunk-shadow:none;--ui-text-body:0.875rem;--ui-text-display:2.25rem;--ui-text-heading:1rem;--ui-text-title:1.375rem;--ui-tint:color-mix(in srgb, var(--ui-accent) 70%, transparent);--ui-weight-heading:600;}
      [data-ui-style="voxel"]{--ui-block-opacity:1;--ui-border-width:var(--ui-step);--ui-container-radius:0;--ui-control-radius:0;--ui-field-shadow:inset 0 calc(var(--ui-step) / -2) 0 0 var(--ui-border);--ui-focus-width:var(--ui-step);--ui-font-body:VT323, monospace;--ui-font-heading:VT323, monospace;--ui-font-mono:VT323, monospace;--ui-frame-shadow:0 calc(var(--ui-step) * -1) 0 0 var(--ui-border), 0 var(--ui-step) 0 0 var(--ui-border), calc(var(--ui-step) * -1) 0 0 0 var(--ui-border), var(--ui-step) 0 0 0 var(--ui-border), inset 0 var(--ui-step) 0 0 color-mix(in srgb, var(--ui-text) 8%, transparent);--ui-heading-color:var(--ui-accent);--ui-hover-filter:brightness(1.25);--ui-hover-overlay:none;--ui-indicator-width:calc(var(--ui-step) / 2);--ui-lifted-shadow:0 calc(var(--ui-step) * -1) 0 0 var(--ui-border), 0 var(--ui-step) 0 0 var(--ui-border), calc(var(--ui-step) * -1) 0 0 0 var(--ui-border), var(--ui-step) 0 0 0 var(--ui-border), inset 0 var(--ui-step) 0 0 color-mix(in srgb, var(--ui-text) 8%, transparent);--ui-line-fill:repeating-linear-gradient(to right, var(--ui-accent) 0 calc(var(--ui-step) * 4), transparent 0 calc(var(--ui-step) * 5));--ui-line-snap:calc(var(--ui-step) * 5);--ui-pill-radius:0;--ui-pressed-overlay:none;--ui-raised-background:var(--ui-border);--ui-raised-color:var(--ui-text);--ui-raised-shadow:inset calc(var(--ui-step) / -2) calc(var(--ui-step) / -2) 0 0 color-mix(in srgb, var(--ui-background) 45%, transparent), inset calc(var(--ui-step) / 2) calc(var(--ui-step) / 2) 0 0 color-mix(in srgb, var(--ui-text) 20%, transparent);--ui-scrim:repeating-conic-gradient(var(--ui-background) 0 25%, transparent 0 50%) 0 0 / calc(var(--ui-step) * 2) calc(var(--ui-step) * 2);--ui-sunk-background:var(--ui-background);--ui-sunk-shadow:inset 0 calc(var(--ui-step) / -2) 0 0 var(--ui-border);--ui-text-body:calc(var(--ui-step) * 5);--ui-text-display:calc(var(--ui-step) * 12);--ui-text-heading:calc(var(--ui-step) * 6);--ui-text-title:calc(var(--ui-step) * 8);--ui-tint:var(--ui-accent);--ui-weight-heading:normal;}
      }"
    `);
  });
  ...
  test("generates a shape after every surface it lays its corner over", async () => {
    ...
    const uno = await createGenerator(unoConfig);
    const { css } = await uno.generate("<div ui-field ui-frame ui-lifted ui-pill ui-raised ui-sunk />", {
      preflights: false,
      safelist: false,
    });
