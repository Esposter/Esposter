...
// `leaveRoom` event every other client prunes its member list from, and the line saying who went. Left to each
// Call site, a moderation kick deletes a membership row nobody is told about
