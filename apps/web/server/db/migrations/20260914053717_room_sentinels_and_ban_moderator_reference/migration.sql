...
ALTER TABLE "message"."bans" ADD CONSTRAINT "bans_bannedByUserId_users_id_fkey" FOREIGN KEY ("bannedByUserId") REFERENCES "users"("id") ON DELETE SET NULL;--> statement-breakpoint
...
ALTER TABLE "message"."rooms" DROP CONSTRAINT "rooms_slowmodeMs_check", ADD CONSTRAINT "rooms_slowmodeMs_check" CHECK ("slowmodeMs" >= 0);