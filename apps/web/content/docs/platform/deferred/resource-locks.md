...
Single-owner resources today — the type-the-name delete confirmation ([resource page parity](/docs/platform/resource-page-parity)) and the [recycle bin](/docs/platform/recycle-bin) already cover accidental destruction, which is the entire threat model locks address without collaborators.
