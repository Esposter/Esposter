...
The Sheet editor's in-session variant was rejected separately and for a different reason — see [named checkpoints](/docs/sheet-editor/rejected/named-checkpoints), where undo/redo already traverses prior states.
