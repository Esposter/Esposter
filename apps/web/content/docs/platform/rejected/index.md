---
title: Rejected
description: Platform ideas we decided against — one page per idea, with the rationale.
---

# Platform rejected ideas

One page per rejected idea (won't do). Check here and [deferred](/docs/platform/deferred) before adding a roadmap item or proposal — never re-argue a decided idea.
...
- [Resource icon customization](/docs/platform/rejected/resource-icon-customization) — the type icon is the identity signal; tags personalize
- [VuetifyComponent resource type](/docs/platform/rejected/vuetify-component-resource) — a demo, not a user artifact
