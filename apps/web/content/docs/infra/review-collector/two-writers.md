...
| `main`            | the collector merging a release or cutting the express lane                          | everyone         | `develop` follows it by fast-forward on the merge; a cut or a bump landing there is folded into the next window |
