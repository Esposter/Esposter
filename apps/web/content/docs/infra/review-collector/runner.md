...
| replay resolver | a queue commit conflicts with the tree the window is built on, outside the lockfile | per commit, 3                            | the sequence run to its end over a clean tree                |
