...
| fold resolver   | `main` conflicts with the window, or with a reviewed release, outside the lockfile  | per `main` head                    | the merge committed over a clean tree                                                 |
...
| `.github/actions/setup-project-dependencies`                  | pnpm, node and the store cache                                                                                          |
| `.github/actions/install-projects`                            | the install, narrowed to the collector's own projects                                                                   |
