...
| reshaper        | the first owed commit alone exceeds the cap                                         | per commit                         | the same tree as the original, every untrailered part fits   |
