...
flowchart TD
  ...
  C --> E{Exited clean<br/>with a clean tree}
  E -->|no| F[Failed-attempt marker, run fails]
  E -->|refused to start| M[Limit marker with the reset instant]
