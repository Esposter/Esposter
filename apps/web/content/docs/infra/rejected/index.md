...
- [SDK-driven companion](/docs/infra/rejected/sdk-driven-companion) — a companion window driving a Claude session of its own; metered where everything else is free, and a second session holds none of the work.
