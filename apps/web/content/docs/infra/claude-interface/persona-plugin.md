...
| `packages/genshin-persona/src/services/getSpinner.ts`              | Both verb layers; one tip layer under one label — the card's tips, then the lines, cut at the tool's cap    |
