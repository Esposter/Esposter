...
- **A character the data package has no lines for shows their one-line description rather than English lines**, because the wiki that carries them is English only and a spinner mixing two scripts reads worse than one line does.
