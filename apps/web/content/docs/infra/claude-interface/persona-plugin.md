...
| `packages/genshin-persona/src/services/drawLoreChoice.ts`          | The tier's odds blended with an even share, and the draw over them                                                                                  |
| `packages/genshin-persona/src/services/getSessionStartOutput.ts`   | The two readers' subsets: the whole card as context, the nameplate, note, remarks and greeting as the welcome                                       |
