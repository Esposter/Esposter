...
| The working spinner and its tips   | a working line closing the conversation, with the turn's verb, its elapsed time, the tokens the turn has written, Escape to interrupt, and a tip                                                                           | partial: the tips are the console's own, since the SDK does not send Claude Code's                             |
