...
| Tool calls and their results       | each call folded in place in the conversation over the opening of its output, as the terminal shows it; the character at the station of the call it waits on; and the timeline panel                                       | done                                                                                                           |
| File edits                         | a side-by-side diff per edit, the pages stacked on the workbench, and the changes panel merging every edit to a file into one diff from where the file started, its unchanged runs folded                                  | done                                                                                                           |
...
| Todo list                          | a checklist at the top of the timeline panel, kept by the terminal's task tools, which the host gives every SDK session                                                                                                    | done                                                                                                           |
