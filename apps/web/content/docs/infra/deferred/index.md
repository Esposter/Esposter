...
- [Lore-based pick](/docs/infra/deferred/lore-based-pick) — the persona pick weighing festivals, anniversaries and the person's context behind an opt-in typed-decision key; waits on a roster-sized answer set and a start with no network call
