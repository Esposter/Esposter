...
- **Filtering & sorting** — column sort and multi-column sort on the underlying value, per-column filters, global search over the displayed text, frozen row-number column.
