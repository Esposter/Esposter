...
- Collaboration and comments remain platform-wide deferrals ([collaboration](/docs/resource/deferred/document-collaboration), [comments](/docs/resource/deferred/resource-comments)), and version history is platform-wide ([resource snapshots](/docs/resource/resource-snapshots)); Note rides what the platform does. Markdown export (the Portable capability) is a natural follow-on, not bundled.
