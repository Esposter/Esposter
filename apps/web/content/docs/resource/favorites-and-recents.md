...
It is deliberately not called a view. `ResourceViewEntity` counts anonymous hits on a _published_ resource ([published view analytics](/docs/resource/published-view-analytics)); this records the owner opening their own.
