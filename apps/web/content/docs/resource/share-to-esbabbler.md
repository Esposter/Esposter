...
flowchart LR
  ...
  DLG -->|room.readRooms| ROOMS["your rooms → UiSelect"]
...
- **Success lands in the [notifications](/docs/resource/notifications) store** with an **Open room** action.
...
| `app/components/Resource/Blade/Header.vue` | the Share action (publishable + published) |
