...
[Global search](/docs/resource/global-search) tolerates typos. "survye" finds Survey, at zero service cost and no new Azure resource.
...
- Azure AI Search stays [deferred](/docs/resource/deferred/azure-ai-search) — nothing at current volumes needs it, and this is the cheap 80%.
