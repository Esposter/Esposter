...
- [the UI library](/docs/proposals/refactors/ui-library) — carry the agent console's voxel look across the app on a library of our own over Vuetify 0's headless primitives, stage by stage, ending with Vuetify retired.
