...
| [Schema forms](/docs/architecture/schema-forms), shipped                  | JSON Forms, dressed in the library, for the forms generated from Zod schemas                  | The sheet column and dashboard dialogs match the rest of the app, and the last Vuetify-bound engine goes |
