...
Part of [world first](/docs/proposals/infra/agent-console/world-first). The [console overlay](/docs/proposals/infra/agent-console/world-first/console-overlay) takes away clicking the room, and the [player](/docs/proposals/infra/agent-console/world-first/player) gives the person a figure to walk. This stage connects the two. A thing in the room does something again, but only for a player standing at it, and only after the world has shown what it will do.
