...
**Mutations** — three procedures, each a transaction that writes the like row, adjusts `likeCount`, and recomputes the stored [ranking](/docs/post/feed-and-ranking) from the new count:
