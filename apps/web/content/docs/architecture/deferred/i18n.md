...
Nothing in the repo translates text today: the schema forms show the Zod schema's own messages, and no package carries a translation layer the UI could reuse.
