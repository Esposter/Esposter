...
| [Radix Colors, understanding the scale](https://www.radix-ui.com/colors/docs/palette-composition/understanding-the-scale)                                                     | Which step of a neutral scale is a background, a component, a border and a text colour: the standard palettes' slate and green                                         |
