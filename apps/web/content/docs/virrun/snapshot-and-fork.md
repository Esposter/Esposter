...
| `services/exec/util/getGlobalCacheDirectory.ts`                                | where the snapshot root above is decided                                                                                      |
