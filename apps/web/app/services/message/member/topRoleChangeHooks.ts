...
type TopRoleChangeHook = (roomId: string, previousTopRoleId: string, newTopRoleId: string) => void;
...
export const topRoleChangeHooks = createHookRegistry<TopRoleChangeHook>();
