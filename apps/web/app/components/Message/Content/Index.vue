...
<!-- The room is one column: its header, the call, the list that scrolls, and the composer, which stays at the foot
     of the column rather than floating over the page -->
<template>
