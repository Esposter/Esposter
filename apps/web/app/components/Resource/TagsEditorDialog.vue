  ...
  >
    <div flex flex-col gap-2>
      <div v-for="(row, index) of rows" :key="index" flex gap-2 items-start>
        ...
        <StyledTooltipIconButton icon="i-mdi:delete" text="Remove tag" @click="rows = rows.toSpliced(index, 1)" />
      </div>
      ...
      <StyledButton
        ...
        :button-props="{ prependIcon: 'i-mdi:plus', size: 'small', text: 'Add tag' }"
        w-fit
