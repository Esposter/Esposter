...
// Mark and its block are decoration beside the words, which say it all
defineSlots<{ default: () => VNode }>();
const { meaning, token } = defineProps<Props>();
</script>

<template>
  <span text-sm px-2 inline-flex gap-1 h-6 items-center ui-sunk ui-pill>
