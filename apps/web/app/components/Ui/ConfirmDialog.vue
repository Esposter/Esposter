...
// Dialog, as the pattern has it, that opens onto Cancel so a stray Enter never destroys anything. The answer is
// Pending until the caller completes it, and a failed one keeps the dialog open to try again
