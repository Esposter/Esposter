...
export const INVITE_EXPIRE_AFTER_MINUTES_OPTIONS = Object.values(InviteExpireAfterMinutesMap);
// Discord's invite max-use options; "No limit" (the 0 sentinel) lives in the select
