...
export const flowchartEditorSchema = z.object({
  ...
  edges: createUniqueArraySchema(graphEdgeSchema, "id").max(MAX_RESOURCE_CONTENT_SIZE),
  nodes: createUniqueArraySchema(graphNodeSchema, "id").max(MAX_RESOURCE_CONTENT_SIZE),
