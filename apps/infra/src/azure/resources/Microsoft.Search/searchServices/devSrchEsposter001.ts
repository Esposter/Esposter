...
export const devSrchEsposter001: azure_native.search.Service = new azure_native.search.Service(
  searchServiceName,
  {
    ...
    encryptionWithCmk: { enforcement: azure_native.search.SearchEncryptionWithCmk.Unspecified },
    endpoint: `https://${searchServiceName}.search.windows.net`,
    hostingMode: azure_native.search.HostingMode.Default,
    identity: { type: azure_native.search.IdentityType.SystemAssigned },
    location: AzureAustraliaEastDisplayLocation,
    networkRuleSet: { bypass: azure_native.search.SearchBypass.None },
    partitionCount: 1,
    ...
    sku: { name: azure_native.search.SkuName.Free },
