...
export const getAzureFunctionEventSubscriptionArguments = (
  ...
  deadLetterDestination: getStorageBlobDeadLetterDestination(storageAccount, deadLetterContainer),
  destination: getAzureFunctionEventSubscriptionDestination(azureFunction, site),
