...
export const todoReminderContentSchema: z.ZodObject<{
  items: z.ZodArray<z.ZodObject<{ dueAt: z.ZodNullable<z.ZodCoercedDate>; id: z.ZodUUID; name: z.ZodString }>>;
}> = z.object({ items: z.array(z.object({ dueAt: z.coerce.date().nullable(), id: z.uuid(), name: z.string() })) });
