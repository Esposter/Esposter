...
// Error (/docs/infra/eventgrid-dead-letter), so a quarantined event is found by inspecting the container. An undeleted
// Original merely lingers until the container's lifecycle rule
