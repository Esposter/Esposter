...
// The separator sits in a character class so it needs no escaping — `String.raw` would keep a backslash literal and
// Turn the separator into regex alternation.
