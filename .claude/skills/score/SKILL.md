...
1. Re-audit each of the nine areas against the code as it exists today — counts (packages, test files, routers, stores), versions, workflows, and CSP/security posture all go stale.
...
Same discipline as the `docs` skill: prose over bullets, magnitudes over precise measurements, every line earns its place. Two rules are specific to this file:
