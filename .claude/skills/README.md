...
- **Two tiers** — `SKILL.md` holds what applies to every task in the domain (~150 lines, one line per rule) plus a trigger-named index; sub-task deep dives live in that skill's `references/*.md`. See `skill-authoring`.
