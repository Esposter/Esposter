...
* **agent-console:** restore the host package the queue rewrite dropped (3/3) ([d85c7b0](https://github.com/Esposter/Esposter/commit/d85c7b0b3cb60b3aff7d38036d22337146e4b7d0))
...
* **azure-mock:** a conditional delete refuses a stale etag, as an update already did ([5c03905](https://github.com/Esposter/Esposter/commit/5c039055658a0387ec43ee35979525274b835e18))
* **azure-mock:** the blob client's delete takes the blob's metadata with it ([95ff3e7](https://github.com/Esposter/Esposter/commit/95ff3e743dd9f543584843ed9883e1fe918c4270))
...
* **build:** record the undici and @platformatic/vfs versions develop's lockfile inlines ([246f6ca](https://github.com/Esposter/Esposter/commit/246f6cab826bac07632e19092339593c1937d972))
...
* **ci:** an aggregate gate fails on a skipped or cancelled dependency, not only a failed one ([cb4ce0e](https://github.com/Esposter/Esposter/commit/cb4ce0e72565c0e5fd89b83d0223e1e488e58127))
...
* **docs:** drop the DocsNavigationGroup interface nothing imports ([320294e](https://github.com/Esposter/Esposter/commit/320294e1f385b3ebe453f37f3c2504334e3bc9e4))
...
* **lint:** import/no-duplicates owns duplicate imports, and a comment inside the import block is settled against ([31a50eb](https://github.com/Esposter/Esposter/commit/31a50ebc56c795145ef4658078eb7afd53a0b292))
...
* **lint:** the Temporal polyfill's global entry is a side-effect import ([a1b518d](https://github.com/Esposter/Esposter/commit/a1b518d95b13689ada517f5bf8f706b3bb01a53c))
...
* **main:** regenerate the artifacts a red head left stale ([0a0618f](https://github.com/Esposter/Esposter/commit/0a0618fca52e77d8f27164f12a5c35c94fccf114))
* **main:** regenerate the artifacts a red head left stale ([e84cd44](https://github.com/Esposter/Esposter/commit/e84cd44654243ad802172c3516e4349c44c7547d))
...
* **resource:** hold the content-encoding window beside its one reader and retake the graph ([aa6328b](https://github.com/Esposter/Esposter/commit/aa6328bfd9547519f74ad3333200e1b45c898c3f))
...
* **resource:** the date input's update handler returns to script, where its disable directive reaches the date rule ([5d39f01](https://github.com/Esposter/Esposter/commit/5d39f01d416df7c351f830c5b1043ba9377a3b51))
...
* **sweeps:** the ledger-coverage label keeps to a name and one qualifier ([3c82499](https://github.com/Esposter/Esposter/commit/3c824998f7019774b93d235d31006d222f4dba74))
...
* **collector:** push drained fixes at once, drop parking and --force ([a371c59](https://github.com/Esposter/Esposter/commit/a371c5962ce7ab58927b4ca200949db04237575f))
...
* **genshin-persona:** every character speaks in a clone of their own voice — Chatterbox resident on this machine, the reference chosen and scored from the wiki, Azure Speech gone (1/4) ([8284f44](https://github.com/Esposter/Esposter/commit/8284f441974b6d17eccaffd39ce4bc825b90fde6))
...
* **genshin-persona:** the spinner tips run under the tool's own prefix, not the character's name (1/2) ([e204e60](https://github.com/Esposter/Esposter/commit/e204e60f21765b8ef92b8ee92beaa274c21ddd87))
...
* **lint:** the generic names the skills ban join id-denylist ([fb8bb13](https://github.com/Esposter/Esposter/commit/fb8bb130507f6a67625993df853b29d26b8b0afd))
...
* **scripts:** the generated voice match — the English reference beside the Japanese one, the whole bank, and the roster's voices fitted from English ([7487cea](https://github.com/Esposter/Esposter/commit/7487ceaf25065763975727fc8437f569556c061f))
...
* **scripts:** the reference profiles, generated — 96 characters measured from their own lines (1/3) ([7db0b38](https://github.com/Esposter/Esposter/commit/7db0b386cb413485277cce7ad5aa430f865040ca))
...
* **skills:** product-review — the repeatable gap pass that converges on zero new proposals ([0f6d779](https://github.com/Esposter/Esposter/commit/0f6d7796ec2eb23326f650686e9c6b3fcab6c6ab))
...
* **ci:** the userns sysctl reports its own failure ([96b847e](https://github.com/Esposter/Esposter/commit/96b847e460c76d6b6944536f2c726f7ed18741cb))
...
* **review-collector:** the runner declares the two secrets for one release, so main's named trigger still calls ([67dbe0d](https://github.com/Esposter/Esposter/commit/67dbe0d017c462dad26b35b804170f8b5ca686cb))
...
* **workflows:** build the shared package before the collector runs ([a64566d](https://github.com/Esposter/Esposter/commit/a64566dfa82c287b00876ae0da449a6be1589208))
...
* **keyframe-store:** content-addressed version store over zstd keyframes and deltas ([fc96c29](https://github.com/Esposter/Esposter/commit/fc96c29e4f9a0151cbd3bedf8fdb9faffb00444d))
...
* **ci:** the bubblewrap install runs only where the binary is missing ([507b9e0](https://github.com/Esposter/Esposter/commit/507b9e019fca2486953bcccd79b98a4e71ea901f))
...
* **app-shell:** import RoomRoleInMessage in getMemberGroups ([dc61611](https://github.com/Esposter/Esposter/commit/dc61611160c20ffbd7b2383945ccb28405211ee3))
...
* add bench ledger ([a09be13](https://github.com/Esposter/Esposter/commit/a09be135ca97c0c5aec2a12262307d6df74b7920))
* **app:** a failed word-filter read no longer renders the form ([d4b98f7](https://github.com/Esposter/Esposter/commit/d4b98f7690c0c0f0acedaa7a90fe4f5334b683a2))
...
* **bench:** the root declares the reporter it resolves, which is not a dependency it imports ([aa78069](https://github.com/Esposter/Esposter/commit/aa780696107b27c85ee993a704a20f08a7b8ad78))
* **build:** the deploy builds the toolchain it runs the app build with ([fe6e48b](https://github.com/Esposter/Esposter/commit/fe6e48bb358f0cde97d2d150a7b4c63af429aaa7))
* **call:** the admin action builder names the three action types it sends ([ab99c57](https://github.com/Esposter/Esposter/commit/ab99c57f6c78b6c10665dbedfcdb6af9be74cf63))
* **ci:** a narrowed install takes the root's closure, not the root alone ([314d0ff](https://github.com/Esposter/Esposter/commit/314d0ff1bf64999d2a5dda102f152e6d28aa7011))
* **ci:** restore the docs search cast and move the functions bundle snapshot ([0ee3ca7](https://github.com/Esposter/Esposter/commit/0ee3ca7b3645d4f86764bd9378845556da92fef6)), closes [#1153](https://github.com/Esposter/Esposter/issues/1153)
* **ci:** the blob reports land where vitest 5 writes them ([ca6c83f](https://github.com/Esposter/Esposter/commit/ca6c83f6e2788946e6992a45e645ba45ea99e6e2))
* **ci:** the coverage shards build the two app bundles the suite reads ([5598e28](https://github.com/Esposter/Esposter/commit/5598e287eb5295ea856fdc93211bd029659ecee7)), closes [#1143](https://github.com/Esposter/Esposter/issues/1143)
* **ci:** the deploy installs take the root's closure too ([04a915b](https://github.com/Esposter/Esposter/commit/04a915bcbc4c71994297e3e7ee89460336ec6337)), closes [#1143](https://github.com/Esposter/Esposter/issues/1143)
...
* **ci:** the two snapshots and the lint pass no local lane runs ([9b9f3ed](https://github.com/Esposter/Esposter/commit/9b9f3ed70ae9c712fc3efa213a05323dda656bc9))
* **clicker:** an unowned target stops counting itself, not the rest ([6578c8e](https://github.com/Esposter/Esposter/commit/6578c8e50b2e95753b20aa27392e31163b471e2f))
* **comments:** answer the CodeRabbit findings on 3744ea417 ([d744f7e](https://github.com/Esposter/Esposter/commit/d744f7e6cde08f30c8068f5c9833e77b348f2b5d))
* **comments:** answer the CodeRabbit findings on d05a6e7a6 ([244e8d8](https://github.com/Esposter/Esposter/commit/244e8d84b22c7999494870d9d2cb8e73b2b56a2b))
* **comments:** answer the three CodeRabbit findings on b2d4acdb9 ([ad2ae45](https://github.com/Esposter/Esposter/commit/ad2ae459d3bd1b66f5ecfcc31952071fa998a353))
* **comments:** finish the two clipped useEditor sentences ([b2d4acd](https://github.com/Esposter/Esposter/commit/b2d4acdb90aaf6a93225e4622c8013ba5482fe66))
...
* **composables:** the recorder's preconditions are one chain, closed and inverted ([7db6d02](https://github.com/Esposter/Esposter/commit/7db6d02a059a0251f12e17f2f7c8e68f9b7dbde6))
...
* **db:** the else that closed the chain moved the bundle ([2bee627](https://github.com/Esposter/Esposter/commit/2bee627b915f99286a9d11e5d1589234bceaf25c))
* **deps:** cap the unocss trio at 66.9.x, where the inspector still uses h3 1.x ([8af1e71](https://github.com/Esposter/Esposter/commit/8af1e71d4f94948b141fef0ccc9aacf769a05409))
* **docs:** four counts the repo had already moved past ([7244c3d](https://github.com/Esposter/Esposter/commit/7244c3d6fc52f23853452e5209747345b4f4298c))
* **docs:** the five things the review was right about ([cc81a04](https://github.com/Esposter/Esposter/commit/cc81a04737ae76d7194d5aa6f2041ec5f863ac4f))
* **dungeons:** the tiled property reader keeps the cast that gives Tiled a shape ([ef294ae](https://github.com/Esposter/Esposter/commit/ef294ae0908f634a7c3f7bc209ac60163fd9c36c))
...
* **functions:** the bundle snapshot measures the zod the build just swallowed ([f972abd](https://github.com/Esposter/Esposter/commit/f972abddb18c316603df79291f6a502a61e3961f))
* **infra:** the App Service connector icon is pinned to the published value ([c55cd5e](https://github.com/Esposter/Esposter/commit/c55cd5ed3b06619dbcd06a871a521a9289b61df8))
* **ledgers:** the typescript find recipe reads the app tree ([dcafd0c](https://github.com/Esposter/Esposter/commit/dcafd0cbc75955a8494d2b0dfbc160fe088290c5))
* **lint:** await the created row instead of chaining off its promise ([dc0e7f5](https://github.com/Esposter/Esposter/commit/dc0e7f5c81a6e08e3b553d8efe39a38e8e113053))
...
* **lint:** rewrap the session test comment off its leading identifier ([d5a10f3](https://github.com/Esposter/Esposter/commit/d5a10f3e90f0d7096fb47d6bbd00d6a0e759e207))
* **lint:** sort the skill-docs finding enum members ([4515d72](https://github.com/Esposter/Esposter/commit/4515d7250cfda3d11444056c8516946fed7ce621))
* **lint:** the app's vitest project name sorts where the rule puts it ([7c1d228](https://github.com/Esposter/Esposter/commit/7c1d228f5cfc5ca71e6270de9abbc70224739a8e))
* **lint:** the new scan's replaceAll and its filter callback ([e3b682e](https://github.com/Esposter/Esposter/commit/e3b682e42190c320c4346412b47d3c223cbc0153))
* **lint:** the repo-wide oxlint pass, which no package script runs ([fff1d34](https://github.com/Esposter/Esposter/commit/fff1d34d50b8b3e0102d27bded67f957384181ac))
* **lint:** the scan's filter parameter no longer shadows its loop variable ([f675ad2](https://github.com/Esposter/Esposter/commit/f675ad20aa48eb1621d509997559200afa14a1db))
* **lint:** the scoped import bans were each missing a ban they never named ([9920710](https://github.com/Esposter/Esposter/commit/9920710b7f7814103cd963b42762239e3c09210c))
...
* **message:** an empty body is a body the edit rollback restores ([337f3d1](https://github.com/Esposter/Esposter/commit/337f3d15774d0f107dc1047441963074b2b88efe))
...
* **phaser:** a scene event listener is removed by the reference it was added with ([44562a6](https://github.com/Esposter/Esposter/commit/44562a680b0560dc041e8ceae24b432a46b1f292))
* **resource:** the unwritten-edit signal is a flag, not a count of armed debounces ([6001225](https://github.com/Esposter/Esposter/commit/6001225620b3ecf1b02fc59a85dc9ddce46307f0))
* **review:** a gate hides a panel, so the read behind it carries the gate itself ([a825528](https://github.com/Esposter/Esposter/commit/a825528d7d2ee9a1244298755c9b5d15b966bd8d))
...
* **review:** the save state answers for one resource, and the config says what it does ([caeb8f2](https://github.com/Esposter/Esposter/commit/caeb8f2d8806311d420f7cc2f2d7e26cddb71b35))
* **scripts:** a yaml section is found whether it ends its lines with LF or CRLF ([9dad640](https://github.com/Esposter/Esposter/commit/9dad64098e69dc9bf24dc2707350f070f97d7dfd))
* **scripts:** read both edges of the unterminated-Result call name ([12c564b](https://github.com/Esposter/Esposter/commit/12c564bf4b096b1bbd4fc0c9264a8cdd5be7664c))
* **scripts:** the process filter walks up to the workspace, not to the tree it moved into ([06f84c2](https://github.com/Esposter/Esposter/commit/06f84c2a2f2d73fffc395ae01fca8cbe16fc85cc))
* **scripts:** the process filter walks up to the workspace, not to the tree it moved into ([e954551](https://github.com/Esposter/Esposter/commit/e95455108f2983d2b5d5fc97ea6b2a3817251098))
* **scripts:** the review's three findings on the new sweep scans ([43f82bc](https://github.com/Esposter/Esposter/commit/43f82bc8975d52488f338b8381eb1a1636b1ce7b))
* **scripts:** the scan's binding check reads a whole identifier ([4b476cc](https://github.com/Esposter/Esposter/commit/4b476cce7721ede0d65462512c0024942c02cc1d))
* **scripts:** the unterminated-Result scan reads what precedes the call ([35ee2da](https://github.com/Esposter/Esposter/commit/35ee2da42193c097059f6630904c6446fa741cf0))
* **server:** the chained guards invert where the terminal else made them negated ([930e477](https://github.com/Esposter/Esposter/commit/930e477aa657b9af44d0ce0c0fef6ead1632115c))
* **skills:** move root bench rows to Root Scripts in package-scripts skill ([5d240db](https://github.com/Esposter/Esposter/commit/5d240dbba84a0a2648f0ae04bcdccba8ce26de66))
...
* **sweeps:** the unterminated-result scan reads its boundaries from the source ([846608d](https://github.com/Esposter/Esposter/commit/846608d93d48678a5c05b758f90418b04c62700f))
* the checks CI runs, run from the root ([5fbd69a](https://github.com/Esposter/Esposter/commit/5fbd69a7724038b39e3adcab3b7a3249c022dbf8))
* the prose and the bundle snapshot follow the files that moved ([b584996](https://github.com/Esposter/Esposter/commit/b5849969f0e291aadf568b19e25010ac558f6f02))
* **tooling:** the libraries build outside the sandbox, the app inside it ([b59e8ff](https://github.com/Esposter/Esposter/commit/b59e8ff3e4766628272665950174afbfa54a9587))
* tooltip ([8fbb68d](https://github.com/Esposter/Esposter/commit/8fbb68df3ce3605fd844e8b97d1fb61d96d8749e))
* **trpc:** a read with no row answers undefined, and isPending carries "not loaded" ([f281320](https://github.com/Esposter/Esposter/commit/f281320c37adfe8ed30fb29ab5b54df796b636ee)), closes [#1142](https://github.com/Esposter/Esposter/issues/1142)
...
* **util:** the dictionary-to-array parse writes the id back onto the entry it read ([a9565b2](https://github.com/Esposter/Esposter/commit/a9565b2ea204a175bc430a3672951d31a9c7de5a))
* **util:** the id annotation is load-bearing, and the copy-on-write map earns its disable ([569587f](https://github.com/Esposter/Esposter/commit/569587fd429c965da1857e515ec5321df8a1b3cc))
...
* **oxlint:** id-denylist takes the three abbreviations that have no site left ([1e688f5](https://github.com/Esposter/Esposter/commit/1e688f53d1c778308fe8416b718ff642fa00397e))
...
* **sweeps:** a ledger's scope is a declared pathspec, not prose ([0abc182](https://github.com/Esposter/Esposter/commit/0abc182289c8d54823f1312e7a56cc96fb81ed81))
* **sweeps:** typescript earns a ledger, and the index count counts itself ([69d70eb](https://github.com/Esposter/Esposter/commit/69d70eb70bddf3ad94f20e2714041c083d39cf3e))

### Performance Improvements

* **ci:** the format check installs the project that declares its binary ([66c0dc1](https://github.com/Esposter/Esposter/commit/66c0dc1ee1458330f29d29bdfa18e34f263dc1b2))
* **test:** the app opts into the transform cache too ([071c90c](https://github.com/Esposter/Esposter/commit/071c90caca649deb85daf778a0d4dc98c8f4f805))
...
* **deps:** the Renovate manifest workflow buys nothing here ([6a54e83](https://github.com/Esposter/Esposter/commit/6a54e83f872dcdda24a1ed8fe96bc39f938422a9))
...
* **ci:** the package build cache is asked for the right thing ([e3e1b73](https://github.com/Esposter/Esposter/commit/e3e1b7337d6994b4f20e7e3e57c687a3f37b9842))
...
* dep graph ([d188dcb](https://github.com/Esposter/Esposter/commit/d188dcb0117409f1c681eca08ecba6cda5429a3b))
* **depcruise:** resolve exports maps so the graph has edges again ([c575722](https://github.com/Esposter/Esposter/commit/c575722d2f8aeeb99bf4e21356bb1219f90b7951))
* **deps:** the merged lockfile resolves from main's side, keeping one `@tiptap/core` ([a6fee87](https://github.com/Esposter/Esposter/commit/a6fee876436e8d3518978d89796c05c35e7c37aa))
...
* **graph:** stripe the private legend swatch across all three role colours ([0a3ce81](https://github.com/Esposter/Esposter/commit/0a3ce813a7368fd0afc7b12dfeadf94cb35fb019))
...
* lint ([59e5b3e](https://github.com/Esposter/Esposter/commit/59e5b3ea9808f85918472745db769f99185442d5))
* **lint:** allow the apexcharts feature registrations as unassigned imports ([2eb0242](https://github.com/Esposter/Esposter/commit/2eb024276c83885e56e6227f5b4d75e5f7924cf1))
...
* **release:** the publish chain builds before it tests, and leads with the cheapest check ([932fbe3](https://github.com/Esposter/Esposter/commit/932fbe38dc0fda14a1a0868ac3c8a8d5279b7469))
...
* remove unnecessary tsconfig ([a3975f6](https://github.com/Esposter/Esposter/commit/a3975f66668b92d5a213486f9f047f758eafb298))
...
* **review:** a message written after a spread is still decidable ([6561ad9](https://github.com/Esposter/Esposter/commit/6561ad94d074c4b3c0f9dff4046e14627fcf2daa))
* **review:** a spread may supply the message the rule demands ([83cf1b7](https://github.com/Esposter/Esposter/commit/83cf1b7fda39b80a84e0cd225250219da226047e))
* **review:** every ledger find recipe named paths that do not exist ([48ef358](https://github.com/Esposter/Esposter/commit/48ef358b58897f8e00ea4176ce1b96340b4dda38))
...
* **scripts:** a package name is not an identity for an outdated dependency ([f0f15b9](https://github.com/Esposter/Esposter/commit/f0f15b9d0a125728cd028bdc5ce7644ffb91f6f0)), closes [#1113](https://github.com/Esposter/Esposter/issues/1113)
* **scripts:** refresh:lockfile bounds its path match and stops on a removal it could not do ([1d2282b](https://github.com/Esposter/Esposter/commit/1d2282bac29eeb6bb69d9108b9d6b1badff9f0f2))
* **scripts:** refresh:lockfile kills only the node processes that name this workspace ([237b6f2](https://github.com/Esposter/Esposter/commit/237b6f27142270ce52d8b31d4d68cbf0af7bde44))
...
* **scripts:** the graph's roles separate for a dichromat, measured rather than guessed ([48f680a](https://github.com/Esposter/Esposter/commit/48f680ac0629c9f9f7af20052c672cb803bd6bd5))
* **scripts:** the symlink guard matches `..` as a path component ([847d272](https://github.com/Esposter/Esposter/commit/847d2725f61754ded440814419c7455bbe72e9fa))
* **scripts:** the symlink guard reads the tree the fetcher walks ([5480b25](https://github.com/Esposter/Esposter/commit/5480b2544e3228e5c18c641f6006888ec74d357f))
* **scripts:** the two manifest invariants read a value the way a bundler does ([875f068](https://github.com/Esposter/Esposter/commit/875f06874be4a08a29c41e833b771b302b6aaa45))
...
* **scripts:** the dependency graph colours a package by the role its edges give it ([39abc8a](https://github.com/Esposter/Esposter/commit/39abc8a89813a3739a459e0e6d8c0ac0e76233cb))
...
* upgrade pnpm ([2546941](https://github.com/Esposter/Esposter/commit/254694111d2e06f0952c3f1957bfec10c43339cf))
* upgrade pnpm ([a1e7b75](https://github.com/Esposter/Esposter/commit/a1e7b750291acd4a83eb307aa90c3b322c2dadf0))
...
* **azure-mock:** refresh bundle size snapshot for MockBlobClient.getProperties ([9d3d902](https://github.com/Esposter/Esposter/commit/9d3d902a1f6ea39c7f06d6d939ae6f91d34e9168))
...
* lint ([bfdbde8](https://github.com/Esposter/Esposter/commit/bfdbde8cd7f50046f6e108c98588c44d1fdd4043))
...
* **lint:** hoist the vote-button like factory out of its describe ([61867c9](https://github.com/Esposter/Esposter/commit/61867c912726d121d9b38f8bc2bcd3f0250fcb6a))
...
* snapshot ([67d0bd2](https://github.com/Esposter/Esposter/commit/67d0bd25f897cbbf3f7bb3715ba3a5e593a7c94b))
...
* address the CodeRabbit findings on the review workflow ([a95d1c0](https://github.com/Esposter/Esposter/commit/a95d1c090b2d51472dac5c21e5f58b50a8ff4a88))
...
* clear an unsettleable finding's blocker once its group is settled ([13e74db](https://github.com/Esposter/Esposter/commit/13e74dbe71b8d6250c18fb911a078ada2023f692))
* close round three of the self-review ([964e65e](https://github.com/Esposter/Esposter/commit/964e65e4764a77a6994d4a3ddcb663504ad1c5a4))
* close round two of the self-review ([c048ff3](https://github.com/Esposter/Esposter/commit/c048ff3e63fbd8a3db3a6b9ff8c36f84f98c20f9))
* close the 16 findings the self-review found in the fix round ([750a0a3](https://github.com/Esposter/Esposter/commit/750a0a30ff16bfd824b416f78f5ffea6a7ac0a36))
* close the 18 findings the review found in its own rewrite ([411f866](https://github.com/Esposter/Esposter/commit/411f866a5445ebdd1d53dcb533a06f1622f05814))
...
* close the second CodeRabbit round on the review workflow ([e8144b9](https://github.com/Esposter/Esposter/commit/e8144b9a77cfc5d09a6bd451f90331c2c995b066))
* close the self-review findings and bound the review's cost ([77ad8f7](https://github.com/Esposter/Esposter/commit/77ad8f7e6642a43933e2122547d8cfaf572a3acc))
* close the self-review findings and stop the record drifting from the code ([cd65034](https://github.com/Esposter/Esposter/commit/cd65034cc4f5e58b34c9bb7189bdf1052d45a0b3))
* code review comments ([813b854](https://github.com/Esposter/Esposter/commit/813b854939772e4f8600b85116a22dfbe6374d2b))
* **code-review:** cap the angle-B slice in the split-across-finders helper ([4d262de](https://github.com/Esposter/Esposter/commit/4d262de7936207684674afda3742bfe84b86518e))
* **code-review:** carry resolveCeiling on ReviewStats, and assert it ([772c20e](https://github.com/Esposter/Esposter/commit/772c20e23e9c56df4271eb6f1ffc99fdd522416c))
* **code-review:** close the defects the cleanup pass found in the fan-out cut ([b831982](https://github.com/Esposter/Esposter/commit/b8319820d4b07d6a2fc042992ada21dfab5b2321))
* coderabbit review comment ([e59f376](https://github.com/Esposter/Esposter/commit/e59f376decfa28e69d6eb8c89eb14b6321065bbd))
...
* lint rules ([981169f](https://github.com/Esposter/Esposter/commit/981169f00a52cb12d801aa9364e384a37c3900d5))
* lint the review workflow's tests instead of the whole .claude tree ([793da2c](https://github.com/Esposter/Esposter/commit/793da2ce475ffbb3e57c92a84c0940b1b530531b))
...
* **review:** publish the resolver budget, sort issue comments across pages ([c15e428](https://github.com/Esposter/Esposter/commit/c15e428b0115ca32138ec373371f7d5089498fcc))
...
* tsconfig ([50b5e61](https://github.com/Esposter/Esposter/commit/50b5e61bb46341315f19732f3eff041c2f0a834e))
* typecheck the review workflow tests under isolatedDeclarations ([1f38ad5](https://github.com/Esposter/Esposter/commit/1f38ad578da2c88c66b417a8ddf8d2aaf9198f70))
...
* wip ([aa11e5a](https://github.com/Esposter/Esposter/commit/aa11e5a0c45d3ea129bc5a2bbb68e0cf8a3e97f2))
...
* **oxlint:** enforce pass-through helpers with no-forwarding-wrapper ([ed68fb5](https://github.com/Esposter/Esposter/commit/ed68fb5f93650436ec3513cb2aff0739b50d2a73))
...
* **code-review:** cut the fan-out to what verification is worth paying for ([66dd8f8](https://github.com/Esposter/Esposter/commit/66dd8f89b1aafe1bac8eab6e2835ce0bc8e311d3))
...
* Revert "chore: auto review develop-base pull requests" ([0989497](https://github.com/Esposter/Esposter/commit/09894972c974f120dd9063888679cbac7cdcd2ad))
...
* add more rules ([2728188](https://github.com/Esposter/Esposter/commit/272818858cb1ba19903835512d915252c9e0f81d))
...
* add tests ([2e768ac](https://github.com/Esposter/Esposter/commit/2e768ac5e6e387653074c0df1763502faf28aad5))
...
* coderabbit yaml exclusion ([9243a0e](https://github.com/Esposter/Esposter/commit/9243a0e15d92217c2ba4250c6ba665b53c6f3f34))
...
* commit lockfile for azure-native catalog sync ([5f945d3](https://github.com/Esposter/Esposter/commit/5f945d3e12f61b9f3439778eb0ab3285f9b7d3ba))
...
* correct the skill's h3 example to what the source actually says ([699c41f](https://github.com/Esposter/Esposter/commit/699c41f270556e0365afc3016afb8a4c4733f354))
...
* **deps:** keep the vite override, refresh bundle-size snapshots ([669d7d3](https://github.com/Esposter/Esposter/commit/669d7d39b221144cbb3b355ba00a0608c6c098f6))
...
* docs ([aa13548](https://github.com/Esposter/Esposter/commit/aa13548f6f1364b13abeb43586dd0f0286181a65))
...
* keep TypeScript paths in .vscode/settings.json platform-neutral ([0f0ef9a](https://github.com/Esposter/Esposter/commit/0f0ef9ab3221a37fc032fa39af2cffc937c51201))
* keep typescript.tsserver.nodePath in checked-in editor settings ([644aa85](https://github.com/Esposter/Esposter/commit/644aa858a04beae5484cce864bd4ef89ed27de8b))
...
* more lint ([558c46e](https://github.com/Esposter/Esposter/commit/558c46ed081cb24914d3b7235b7314567aad00c9))
...
* normalize absent severities and disclose cap omissions in review workflow ([9b566b0](https://github.com/Esposter/Esposter/commit/9b566b0c18edfb97bb4dd4dc2f861adb54b09691))
...
* paths ([0309b40](https://github.com/Esposter/Esposter/commit/0309b409000fa56418f4cd54dd0471150f424c4c))
* persist-then-notify rule reads awaits inside block-body map callbacks ([4644708](https://github.com/Esposter/Esposter/commit/4644708c1188ad1bb5ff7fa23d001569fda26811))
* pin yuku-parser to 0.6.5 ([389da53](https://github.com/Esposter/Esposter/commit/389da5313944bab9f31bfda6389d85fc792c7ed0))
...
* report the review's per-finder cap instead of truncating silently ([f090019](https://github.com/Esposter/Esposter/commit/f090019f5fa7b0fa58c001210a3bcea52b182abb))
...
* restore pnpm-lock.yaml ([1da1ea8](https://github.com/Esposter/Esposter/commit/1da1ea8089dcc1dd260763d92ef259a517577ccb))
...
* sync @pulumi/azure-native catalog specifier with lockfile resolution ([a8a1c6e](https://github.com/Esposter/Esposter/commit/a8a1c6e9b76516405219dcd5afd7739710ba3826))
* tag commit shas ([9049d44](https://github.com/Esposter/Esposter/commit/9049d449d93cda48bc85cb528433a30c246ec196))
...
* **configuration:** add esposter/no-null ESLint gate at warn ([5814e60](https://github.com/Esposter/Esposter/commit/5814e60207041ac074dbd8dea7e4159bcc37b3a9))
...
* emit per-finding shortSummary for the compact review table ([a084c7d](https://github.com/Esposter/Esposter/commit/a084c7d9bc35f639b2575820e934ea08f5ed351a))
...
* ground code-review findings in history and the written record ([8bac636](https://github.com/Esposter/Esposter/commit/8bac6364acf61d6e601ddd46e076e4b58ac56478))
...
* partition code-review finders by seam on a large diff ([99268db](https://github.com/Esposter/Esposter/commit/99268dbdadbed13ab83463e8d668aa2527358fb2))
...
* severity ratings in code-review workflow + report format ([dd63e71](https://github.com/Esposter/Esposter/commit/dd63e7100e507ee7cad2c3f26b4da9ad5eda1679))
* **shared:** add nullToUndefined boundary helper ([a44bf63](https://github.com/Esposter/Esposter/commit/a44bf636fc140f53dfba9a26d317c33d685fe29e))
...
* group verifiers by file instead of by line ([d170b07](https://github.com/Esposter/Esposter/commit/d170b0751823129b2816849f0710623daaf2d85f))
...
* add coderabbit ([0982c8f](https://github.com/Esposter/Esposter/commit/0982c8ff42ce395fc074b3497f5807bc04512292))
...
* add resource explorer docs ([594b29e](https://github.com/Esposter/Esposter/commit/594b29e2723056f48bd2a0772498d673d7eb4b69))
...
* config ([64b8054](https://github.com/Esposter/Esposter/commit/64b80541172005bfb8f6ca42c77ac149246eca71))
...
* deps ([b97f0d8](https://github.com/Esposter/Esposter/commit/b97f0d8551a3a49c5ed1e73c61fe316eca013e60))
* doc bugs ([5b0dbdb](https://github.com/Esposter/Esposter/commit/5b0dbdb2d8595197f6e66410031cb570b2157f16))
* docs ([1741640](https://github.com/Esposter/Esposter/commit/1741640c31197822080ecad8b372364bfc037c33))
...
* exclusion ([d5401f5](https://github.com/Esposter/Esposter/commit/d5401f53c66fc36c3e1b708188c29b58907d79c8))
* git attr ([26ebe3c](https://github.com/Esposter/Esposter/commit/26ebe3cb0c6cc923765e6e29347a5be387412273))
...
* md ([de89c9f](https://github.com/Esposter/Esposter/commit/de89c9f3047cde1e88b81f6a7d09059ccbb4c15b))
...
* pin deps ([84fd150](https://github.com/Esposter/Esposter/commit/84fd150b3c336e5281b6e44bb1c6fcb957532cf0))
...
* restore CLAUDE.md symlink mode ([288da03](https://github.com/Esposter/Esposter/commit/288da03a657a52782407fe1d6e71935b43842b24))
* restore CLAUDE.md symlink, apply doc pointer to AGENTS.md ([977d0b6](https://github.com/Esposter/Esposter/commit/977d0b6c4cd288161bd1901e105749531429dd48))
* revert deps ([c9aa408](https://github.com/Esposter/Esposter/commit/c9aa4080a264d197d50e5c205b09f6c6c5472789))
...
* scripts ([f057203](https://github.com/Esposter/Esposter/commit/f0572031898b47130149791f83d95b43c31effc3))
* scripts ([817a54c](https://github.com/Esposter/Esposter/commit/817a54caf626913d70c17bab0d321e07c26250b3))
...
* skills ([6c2b64a](https://github.com/Esposter/Esposter/commit/6c2b64aaeab6c2b77a636b39232924de74c4aad2))
...
* cleanup docs and architecture ([90ae883](https://github.com/Esposter/Esposter/commit/90ae883923a23a23b18d5dc52cb30b0801181af0))
...
* Revert "chore: deps" ([dc3d4de](https://github.com/Esposter/Esposter/commit/dc3d4dee340de79f459b228db94da9dd57b5627a))
...
* always hand off to fnm in update:node even when version is unchanged ([20d7229](https://github.com/Esposter/Esposter/commit/20d7229eb72b921c24e188fe05702cd8f5dd8982))
...
* comments ([155601a](https://github.com/Esposter/Esposter/commit/155601adb3727b2cd224a99098f7010104eef765))
...
* docs ([98fc680](https://github.com/Esposter/Esposter/commit/98fc680136bee3fb9d947a5640457ffb83c86a03))
* downgrade back ([fec0a38](https://github.com/Esposter/Esposter/commit/fec0a38918660daf7517d036db88458336a92d91))
* exclude packages/app from oxlint :packages lint scripts ([ea65015](https://github.com/Esposter/Esposter/commit/ea6501581e920dfed40a98f038f68cfd33990a7b))
...
* harden updateNode/registry scripts per review ([c3a2b09](https://github.com/Esposter/Esposter/commit/c3a2b09b57b37d926da2e5a8b36354774398089b))
...
* lint ([38512b4](https://github.com/Esposter/Esposter/commit/38512b4b7c5a1976c84c36264598660c49d031d5))
* lint ([a02a681](https://github.com/Esposter/Esposter/commit/a02a681337828164d344e35a5ea746c607643992))
...
* pin tsgolint back ([32f5093](https://github.com/Esposter/Esposter/commit/32f50936975c3b97161e1920cbab40449a346c1a))
* pin vue language core ([1135e6a](https://github.com/Esposter/Esposter/commit/1135e6aada43c2713e0c6a983fe1244d72cbe714))
...
* resolve full node version in update:node and silence DEP0190 ([9e4088a](https://github.com/Esposter/Esposter/commit/9e4088aa99465b1946698dfb36a42afb60045e32))
...
* upgrade to ubuntu 26.04 ([a4c6e45](https://github.com/Esposter/Esposter/commit/a4c6e45d342584f0e1ceba91ba07baa68b5a1b38))
...
* skip host pnpm i in virrun verify jobs ([df6d1ea](https://github.com/Esposter/Esposter/commit/df6d1ea027b96235aa4a3dd517a4588d41cfb283))
* skip warm-snapshot setup on cache hit ([29faa83](https://github.com/Esposter/Esposter/commit/29faa833fa0de978b3ca2970c5d01906af31007d))
...
* lint ([3233a20](https://github.com/Esposter/Esposter/commit/3233a20000cfff092cfe786abb64963b801fff47))
...
* prefer-string-raw lint + dependency-check script refactor ([f712f0d](https://github.com/Esposter/Esposter/commit/f712f0d63ed5a4928ce6eb46276c3425a9777e0c))
...
* add back testing packages ([c97f31d](https://github.com/Esposter/Esposter/commit/c97f31d5c6c387c2411154aae7557c1ec76a0c4d))
...
* cleanup settings ([3f07f9e](https://github.com/Esposter/Esposter/commit/3f07f9eb9b3b1416379c77d0fca419e1c0eeb171))
* cleanup skills ([41186c9](https://github.com/Esposter/Esposter/commit/41186c91f8bb972ce092a17626db7e1dbeb3a9ce))
* cleanup skills md ([bb6b256](https://github.com/Esposter/Esposter/commit/bb6b2561ec1cda108e64d87f67f454d2f98ce6fe))
...
* tests and skills md ([59d1b2d](https://github.com/Esposter/Esposter/commit/59d1b2d05e3dbaba0cf4a67984cc2c0fe7368264))
...
* warmup gaps to have buffer ([cabac84](https://github.com/Esposter/Esposter/commit/cabac8423ba7a456daf1a28828a695529658c996))
...
* aggressive caching ([623d1cb](https://github.com/Esposter/Esposter/commit/623d1cb8d0dc751e0c666ec9c11959ee348d457c))
* aggressive sharding to 16 ([d98823c](https://github.com/Esposter/Esposter/commit/d98823c9d9e78c94837a07fd9f57578b05e870e7))
* fix lint + optimize ([0756cc6](https://github.com/Esposter/Esposter/commit/0756cc6f5fc6b2f067959cd484631a45d6e1ee00))
* gate package builds behind single build-packages job ([9a07ca9](https://github.com/Esposter/Esposter/commit/9a07ca9385f66dcbbe16cc8b23a888bbf3b457d0))
...
* try sharding tests ([07db7fe](https://github.com/Esposter/Esposter/commit/07db7fe844c3cf8f7c7a9c2f4db3621a45172cb1))
...
* add skills md ([e6cd51f](https://github.com/Esposter/Esposter/commit/e6cd51f5337450f5ac7d9218be1b1f4e8fe73660))
...
* cleanup lock file ([065ec7a](https://github.com/Esposter/Esposter/commit/065ec7a9ce0a89448329df95729cd5668eb4844a))
...
* code review comments ([6090b1f](https://github.com/Esposter/Esposter/commit/6090b1f2fdbba3f415b64399031a294cb800ef6d))
...
* deps ([ffc6093](https://github.com/Esposter/Esposter/commit/ffc6093bb9c7c0c335579f24d27c1f3e474ebc95))
...
* lint and typecheck for checkCatalogMismatches script ([15a9d9c](https://github.com/Esposter/Esposter/commit/15a9d9c7916505e8376a051400cd4356afb82a86))
...
* lock ([b53a45e](https://github.com/Esposter/Esposter/commit/b53a45ee03bae6d1ba7ca226ef7837ff6e6bfa7d))
* lock + docs ([38d54d2](https://github.com/Esposter/Esposter/commit/38d54d2a1d244a4d3fee24a1c357f1e645b32775))
* mismatch ([d579949](https://github.com/Esposter/Esposter/commit/d5799490bf9d1d735580254f9a799dbbc80ef981))
...
* pin back vue-tsc ([72d95db](https://github.com/Esposter/Esposter/commit/72d95db33496593ff3719d1a088eaa68e012c7c4))
...
* skills ([e683814](https://github.com/Esposter/Esposter/commit/e683814c452abb28c91cafd1f400bd1e18473dd2))
* skills md ([0a4d2c7](https://github.com/Esposter/Esposter/commit/0a4d2c7bd97d6cd41f2c71b4085e1a630f3b0c13))
...
* update skills ([8e54ad6](https://github.com/Esposter/Esposter/commit/8e54ad61db47350999720cebfcb738e1715adb05))
...
* Add claude warmup ([bfc7e95](https://github.com/Esposter/Esposter/commit/bfc7e95cf3b70c63a29a0afd29163130b885fb12))
...
* optimize checking deps ([3bc1b2d](https://github.com/Esposter/Esposter/commit/3bc1b2dbd1459b621645d8940c97f81acf9b5fb9))
...
* add back true ([d320e44](https://github.com/Esposter/Esposter/commit/d320e449ab675dc3899807819371d8a810ab3a1a))
...
* build packages as pre-req ([5145279](https://github.com/Esposter/Esposter/commit/51452793071359f9bda07485b716993218ed4418))
...
* CI/CD ([5a806b5](https://github.com/Esposter/Esposter/commit/5a806b51f36ad4a292edd9be8bb0d4e9c44d48cf))
...
* docs ([8d20113](https://github.com/Esposter/Esposter/commit/8d20113a14643ce4789b0801cd70e34361ca70d0))
...
* perms ([faa1195](https://github.com/Esposter/Esposter/commit/faa1195cca036beb422e9e01aa035a7dadf74520))
...
* use back direct uploads ([227211c](https://github.com/Esposter/Esposter/commit/227211cc27f0ad7653e0a9bcb744970dcdde5c8d))
* use back ubuntu ([17e45a1](https://github.com/Esposter/Esposter/commit/17e45a1da9e7ab0adf9b07685c6be4704fdc4dff))
...
* Add infra ([ddd60e5](https://github.com/Esposter/Esposter/commit/ddd60e50ea813f12650f6bd3820208ac03b0af1e))
...
* add file ([452df56](https://github.com/Esposter/Esposter/commit/452df56d46ae44ab88150a01341f28e8754ee230))
...
* cleanup settings local ([2760b4f](https://github.com/Esposter/Esposter/commit/2760b4f34485059673390d401fff2aaf94d85701))
...
* cleanup warnings and package json scripts ([9de6f9a](https://github.com/Esposter/Esposter/commit/9de6f9a3d46fe6e91bf5cbb83f0575bc621a5520))
...
* remove unnecessary store update ([e9e2efe](https://github.com/Esposter/Esposter/commit/e9e2efe15ef51f5a672e759e38f82a03c77a756c))
...
* skills sync ([8d4dc45](https://github.com/Esposter/Esposter/commit/8d4dc45c693a18d3ed48e022363fabdfce7c5cce))
...
* snapshot ([3a92571](https://github.com/Esposter/Esposter/commit/3a92571b2a2f857ea702ca36b409cd7828eef0ea))
...
* use back old pnpm ([5527e70](https://github.com/Esposter/Esposter/commit/5527e70a72729e99f02f9394eb1d639fa70a4492))
...
* Add pin to digest + auto update actions ([331f5c3](https://github.com/Esposter/Esposter/commit/331f5c3a90e3574962c09d319b065b334c3a14dc))
* Add pulumi CI ([d6ffb10](https://github.com/Esposter/Esposter/commit/d6ffb10e3e509e6c716a17a6c20cf37a4502a67e))
...
* add docs ([23e096c](https://github.com/Esposter/Esposter/commit/23e096c93891780e6ff75048b06be232b5fee292))
...
* add livekit turn ([144834e](https://github.com/Esposter/Esposter/commit/144834e2e527fd9a4bacfed42b32f7b8713f4dba))
...
* allow tcp fallback ([0e00c81](https://github.com/Esposter/Esposter/commit/0e00c818ca30f6eeb65151a8a9443a1b602ff3e6))
...
* cleanup unnecessary defaults ([899e3af](https://github.com/Esposter/Esposter/commit/899e3afcf380243f596d15f9965fc5cce231c27d))
...
* links ([09a6440](https://github.com/Esposter/Esposter/commit/09a64404cf591baa86d946ab204dc582a7ec1bd2))
...
* only deploy runtime deps ([3ace3e2](https://github.com/Esposter/Esposter/commit/3ace3e2888007b928505b23fb336689df9a547bf))
* port ([cedc214](https://github.com/Esposter/Esposter/commit/cedc2146ebff2c6c33fff6988b814c50c81baaca))
* redeploy ([b7e3517](https://github.com/Esposter/Esposter/commit/b7e3517d7d75544de8d9ec9f241f4a92654e0549))
* remove turn ([3a30dba](https://github.com/Esposter/Esposter/commit/3a30dba38f492aa8e1e1a35303b1dba52c0f34ff))
* remove unnecessary env ([35eeaea](https://github.com/Esposter/Esposter/commit/35eeaea785c03a5922b053a9557767ac8f2f4a98))
* remove unnecessary notes ([f5805ec](https://github.com/Esposter/Esposter/commit/f5805ec79c075ef006d71c999212f01ab2209681))
* revert back to node ([1c78d2a](https://github.com/Esposter/Esposter/commit/1c78d2a492c80075a28f0e709c443597b5b07f17))
...
* should be http for internal ([f6a9c89](https://github.com/Esposter/Esposter/commit/f6a9c899109a66c9b3315e45cccb46cf17555330))
...
* unnecessary expose ([982b587](https://github.com/Esposter/Esposter/commit/982b5878e3c94c0f06302256fe980206d28c8b65))
* update gitattributes ([5e2dd9d](https://github.com/Esposter/Esposter/commit/5e2dd9dfd92317dea04aa9fb9e3b8de3ee30ed18))
...
* use proxy instead ([af219d7](https://github.com/Esposter/Esposter/commit/af219d7104e072dd16597f7cbbf86cc9d30db03b))
...
* add back inject ([23c688a](https://github.com/Esposter/Esposter/commit/23c688a058de78d5af820c8df02a32ec8924c3cc))
...
* code review comments ([4943134](https://github.com/Esposter/Esposter/commit/494313403f585f027386d90a6e111aa8ee34739f))
...
* color ([d80c4d2](https://github.com/Esposter/Esposter/commit/d80c4d2c25ce2954e1ca7aaced65d81c67061569))
...
* format ([84341d3](https://github.com/Esposter/Esposter/commit/84341d306fc5a46c3eae98ef4d3caf4407015160))
...
* md ([e5dce63](https://github.com/Esposter/Esposter/commit/e5dce633a0c626306b2ecfa5ae7e9213a37f99a7))
* md and snapshot ([6f1a40b](https://github.com/Esposter/Esposter/commit/6f1a40b5e336041cf805df0dedbca70dd3dbdb93))
* md files ([c64f8c2](https://github.com/Esposter/Esposter/commit/c64f8c24c9c1b0e1c94b8d3638c6efd5ed9e3b45))
...
* package ([97e74fe](https://github.com/Esposter/Esposter/commit/97e74fef75c0efbe0c9ad0eed11310aaf43c1cc9))
* package deps ([86f51ce](https://github.com/Esposter/Esposter/commit/86f51ce3dd3d5617b8445cf2f092db516c0e3fda))
* package manager ([9ab5421](https://github.com/Esposter/Esposter/commit/9ab542187be14abb4f50874a5ed78325a0003dc7))
...
* remove unnecessary things in claude md ([c853f4e](https://github.com/Esposter/Esposter/commit/c853f4e77c555b8ae573e9330df72399ef80fa38))
...
* revert ([4b0c479](https://github.com/Esposter/Esposter/commit/4b0c479e0c010f2cf0060dd60f1d559b2b11e9f5))
* revert node ([8ff5a0e](https://github.com/Esposter/Esposter/commit/8ff5a0e5e5bb76240a473877aa085f63cbecac02))
...
* try new node ver ([e04f605](https://github.com/Esposter/Esposter/commit/e04f605d6b935dd1b12905f26767bc05d5d8d77f))
* turn back format ([6630d98](https://github.com/Esposter/Esposter/commit/6630d981079d84d3bd2ad0927730530b5a07eb7b))
...
* use force legacy deploy for node linker hoisted for azure function apps ([87caa2c](https://github.com/Esposter/Esposter/commit/87caa2c9b004a0ec7fb1a78178d0bdce0761d641))
* use legacy flag instead ([3b01dec](https://github.com/Esposter/Esposter/commit/3b01deca3be754f6d006ff9734d31b9fedeb5e28))
* use new format ([b2601f0](https://github.com/Esposter/Esposter/commit/b2601f00e045aa4f7026ac9fee6a14ba51364468))
...
* wip ([ca1e717](https://github.com/Esposter/Esposter/commit/ca1e7178d40c4c178d5fd4fa057cc7a751165f39))
...
* Add null removal ([ccdb86b](https://github.com/Esposter/Esposter/commit/ccdb86bb5431f4a88945f0ed79bae5855faf9a4b))
* Add self-host livekit ([331c52b](https://github.com/Esposter/Esposter/commit/331c52b55f4fc3c3fa10db7e72dd347b0e213ccd))
...
* upgrade ([1d2fbae](https://github.com/Esposter/Esposter/commit/1d2fbae52f6fe1b7b0ee5882d26db44ac083b3c0))
...
* optimize diff ([ba6f6f5](https://github.com/Esposter/Esposter/commit/ba6f6f5314555cf73a8abff930f56b13dd9ba16f))
...
* coderabbit ([4c373c3](https://github.com/Esposter/Esposter/commit/4c373c3a4d9dd75b5d9502bd1e3062f376f608c0))
...
* md ([95bbd5c](https://github.com/Esposter/Esposter/commit/95bbd5c1d0a299f15c4597ffe00c17ec84d1af56))
...
* pin deps ([1e057c6](https://github.com/Esposter/Esposter/commit/1e057c6e408f83a426be39c22eae5911a9b6952f))
* pin unplugin dts ([b27878c](https://github.com/Esposter/Esposter/commit/b27878c446cf415ed92958e34399452163ed53f3))
...
* remaining md ([3d27572](https://github.com/Esposter/Esposter/commit/3d27572edf810b21f25b81fa8c9dfcf1f266b5cf))
...
* revert back to node 24 for now ([c9e1700](https://github.com/Esposter/Esposter/commit/c9e170068fff13a6153f64ec586dbcb2d27c2734))
* revert workspace ([84155af](https://github.com/Esposter/Esposter/commit/84155af4bbc3831099f42baca631fa18d37c75af))
...
* finally upgrade nuxt ([52f18ac](https://github.com/Esposter/Esposter/commit/52f18acf67d1cbd6bd940f06c5237d16df27f7ea))
...
* upgrade ctix ([6997ff2](https://github.com/Esposter/Esposter/commit/6997ff2f6ae01084dd5451a9e80e25127ba67a86))
...
* add ignore paths for now ([7f0a7f4](https://github.com/Esposter/Esposter/commit/7f0a7f4ff60e40e600c5b2bbef043dca90d65da8))
...
* code review comments ([9e4e507](https://github.com/Esposter/Esposter/commit/9e4e5076bfd94aaef20dfbd254b26a96aa4329dd))

* code review nitpicks ([9dbfc78](https://github.com/Esposter/Esposter/commit/9dbfc78b5b987a9cbd559c7bf0d7a4d2ae6cbb72))

* comments ([55aa6d0](https://github.com/Esposter/Esposter/commit/55aa6d083d26bb0465ec9f762ba9e6b9b9609abe))

* default env to node ([f347f92](https://github.com/Esposter/Esposter/commit/f347f927539441860ed7a6b19f2789f8a91a4686))

* deps ([cab59e0](https://github.com/Esposter/Esposter/commit/cab59e02f68346be7f2de0bf21579fe3457d1d96))

* deps and types ([ca1f5dd](https://github.com/Esposter/Esposter/commit/ca1f5dd6f5a39d1b43ffc8b98ea4833cedebfacf))

* docs ([272be6e](https://github.com/Esposter/Esposter/commit/272be6e0ea7e13022b47314db359f0f90f39f60b))
...
* pin back surveyjs ([9e69a61](https://github.com/Esposter/Esposter/commit/9e69a6103b6911c28c6a7526691921252056dbd9))
...
* remove unnecessary lock ([106d6ac](https://github.com/Esposter/Esposter/commit/106d6ac618f309a7f72c609dda1a2970b0ab7d2c))

* remove unnecessary lock file ([70ef08e](https://github.com/Esposter/Esposter/commit/70ef08e48760f04763694021ed469ab1d2dd5c57))
...
* copy over host.json ([6e8bf7d](https://github.com/Esposter/Esposter/commit/6e8bf7de9dcdd58d830f1aff807b934b4b605e8b))
...
* use back older ver of data-urls that doesn't use SharedArrayBuffer ([77904ac](https://github.com/Esposter/Esposter/commit/77904ac61f60b3fb913afa3fdcd188155de627f8))
...
* cleanup pnpm lock ([bd6d0e4](https://github.com/Esposter/Esposter/commit/bd6d0e416d9a45ce3181318d002b1d8de226fae3))
...
* add back env file even tho it kinda doesn't work still ([f4ab488](https://github.com/Esposter/Esposter/commit/f4ab488c85d2059183da4ce17cde5736f359f3f6))
...
* add back path ([ba108a1](https://github.com/Esposter/Esposter/commit/ba108a190211ad3b3457668a8df1c72008a025de))

* add back quotes ([7eb15b8](https://github.com/Esposter/Esposter/commit/7eb15b882a1a2281a44c313a4bea384d2a412f0d))

* add back respect funcignore ([954a968](https://github.com/Esposter/Esposter/commit/954a96896b7a73ee19a6566ad74c27bfae2a317e))
...
* add fugly node_modules per package for now... ([5b0b661](https://github.com/Esposter/Esposter/commit/5b0b661e287c40c81433e3eadea244654d5ef354))

* add funcignore ([b7ec561](https://github.com/Esposter/Esposter/commit/b7ec561fcec01e9ceee2221dabf5ebd558fabe06))

* add login ([917c6f1](https://github.com/Esposter/Esposter/commit/917c6f129a19546bf632d67052dcc8e1e37c19d3))
...
* add node linker hoisted ([fede995](https://github.com/Esposter/Esposter/commit/fede995c28a6559bcb80a0e15cf1b5e928a406f0))
...
* app filters ([fbc8a77](https://github.com/Esposter/Esposter/commit/fbc8a7738ff68dd4e98e1931275445744cabf5ac))
...
* automate ip ([b423cf0](https://github.com/Esposter/Esposter/commit/b423cf0f11fcd7f2d05789e3592a0c950aab8ac4))

* build and deploy ([673f230](https://github.com/Esposter/Esposter/commit/673f230ac89e2bf40325a41c1b548e08632efbae))

* build then deploy ([744a09c](https://github.com/Esposter/Esposter/commit/744a09cf62478088ac46f9913dccfd61813be2dd))
...
* change back to symlink ([062ec2a](https://github.com/Esposter/Esposter/commit/062ec2a9ea2eff7e8b9e95406944dce26ca7556a))

* change back to use resolve project deps ([f3edb0d](https://github.com/Esposter/Esposter/commit/f3edb0daf01f6ca9b26cae35a9260d480008728a))

* change to accomodate types ([8bd92a0](https://github.com/Esposter/Esposter/commit/8bd92a0441253ff0c3136ca6e8783b65a09b5b1f))

* checkout first ([ac3b49e](https://github.com/Esposter/Esposter/commit/ac3b49e3f71e2738d69aea3aa7a55b1defed7030))
...
* cleanup unnecessary images ([6cf8dac](https://github.com/Esposter/Esposter/commit/6cf8dac816f06a4f9740b1a14f0568fc767b202a))
...
* commands ([be7343c](https://github.com/Esposter/Esposter/commit/be7343c1c1f899e0eb370b3afeca7591c7cff9aa))
...
* copy host.json ([51a95c2](https://github.com/Esposter/Esposter/commit/51a95c2315a9e84def42de984e4b9ebf7efa01aa))
...
* deploy outside ([2a3d992](https://github.com/Esposter/Esposter/commit/2a3d99241d8507827e69483d108e27f54a27a818))
...
* emojis ([8c73730](https://github.com/Esposter/Esposter/commit/8c73730b1f9614d28d7b9083612a591ed5f67365))
...
* files ([02c6f7e](https://github.com/Esposter/Esposter/commit/02c6f7e53f3348de9d2319fbdee3cca3d3dc8269))
...
* hoist node modules ([b3c790a](https://github.com/Esposter/Esposter/commit/b3c790a440bd379e91363b96e9bdbdce0b7aa4a6))

* ignore every node_modules folder ([e40efff](https://github.com/Esposter/Esposter/commit/e40efffedce1058b5d4b1846abac1672ca9a290e))
...
* make single command ([0c62405](https://github.com/Esposter/Esposter/commit/0c624050e58e424e09df8722e4a71a2850d54c34))
...
* name too long ([c46d6b5](https://github.com/Esposter/Esposter/commit/c46d6b5ab1a4fb2ec90048a13e6aace7b443d14f))

* name too long ([06df019](https://github.com/Esposter/Esposter/commit/06df019ce391b29bc042c52bf4a2cc1d71ac5fb3))
...
* only zip webhook ([50d1a75](https://github.com/Esposter/Esposter/commit/50d1a758e92802b463d63367f701a8332146e74a))

* output dir ([c701aac](https://github.com/Esposter/Esposter/commit/c701aac8012f7c07f123ee23b8db2a212671a28c))

* override db url ([7c3fcda](https://github.com/Esposter/Esposter/commit/7c3fcda0092f7768298431b2dddcb60688d6c223))

* package json ([f3fbfed](https://github.com/Esposter/Esposter/commit/f3fbfedc9772b653d34b2f2621d9dbf2612c3bd1))

* path ([f1c3419](https://github.com/Esposter/Esposter/commit/f1c34197668344c29cb085e8f25f7d401393d62c))
...
* properly fetching packages ([ba37bde](https://github.com/Esposter/Esposter/commit/ba37bde17036b7e714f664318c2240d4d2cb4119))
...
* remove unnecessary file ([24deacd](https://github.com/Esposter/Esposter/commit/24deacd7935ca4b1eff7e744f39719de8c7e4b60))
...
* remove user due to eacces and fix up compose ([8fb4995](https://github.com/Esposter/Esposter/commit/8fb49955fe00d3021ce8284ec5281da84be60cfa))
...
* revert pnpm lock ([e72ca00](https://github.com/Esposter/Esposter/commit/e72ca009e60bf5bcae38423cc657d581fae163fe))

* revert pnpm-lock ([b340181](https://github.com/Esposter/Esposter/commit/b34018133d1fe85e24618ac2f75c245e75582d02))

* revert pnpm-lock ([2208289](https://github.com/Esposter/Esposter/commit/22082890758c3bf6a51cf5b47c7cb80c96b2b2ed))

* run id ([e8ba1b0](https://github.com/Esposter/Esposter/commit/e8ba1b0fb036d306cd8464eb9f4ca32daaa4c3f0))

* running ([6c10133](https://github.com/Esposter/Esposter/commit/6c10133ef9aa210f7a3481804b82021f277b58ec))
...
* select all deps ([5d23113](https://github.com/Esposter/Esposter/commit/5d231130cf210e609bf56be4a80b031f4348e576))
...
* settings ([a9b0039](https://github.com/Esposter/Esposter/commit/a9b003986513c02ddd8d505d52861f1af4495117))
...
* steps ([288b490](https://github.com/Esposter/Esposter/commit/288b4903e28910c9dceb776e2d2a0084b6bcb660))
...
* tasks ([f805262](https://github.com/Esposter/Esposter/commit/f80526273a0cc4211f83dd5a34dfdcff12edac47))
...
* try deploy and then build ([98c1156](https://github.com/Esposter/Esposter/commit/98c115672952af75ce834d21a68c5a8d73386459))

* try filter on the front ([fd2186b](https://github.com/Esposter/Esposter/commit/fd2186b799b723a71e698a3b5ef28a265e1d41d7))

* try node linker pnp ([396e7ce](https://github.com/Esposter/Esposter/commit/396e7ce76b9d1b02dd13ca14007d5dd279bee36c))

* try only build pkgs ([ed92479](https://github.com/Esposter/Esposter/commit/ed9247922917e5fb467095a72c5b4b6f1c39e0ca))

* try set symlink to false ([d689679](https://github.com/Esposter/Esposter/commit/d689679894fc6aa46e6c5ffdc180c4bf163f9984))
...
* update CI ([7c47be8](https://github.com/Esposter/Esposter/commit/7c47be85fc87084842194fc0734df7c627b19e66))

* update host.json ([0e6d65e](https://github.com/Esposter/Esposter/commit/0e6d65e05766fa39c8462ad3de72a6b08ae979c5))

* update lockfile ([bb9d08b](https://github.com/Esposter/Esposter/commit/bb9d08b538360b4184ba6a5e6b114cca3bb9c391))

* update partition key ([6056c63](https://github.com/Esposter/Esposter/commit/6056c639c94ee9a9a6560bffd9eac0390d560cc8))

* update publish profile ([f20408b](https://github.com/Esposter/Esposter/commit/f20408bf80ddd9ba69eb3b2426a26cc7fd4083c9))

* update working_dir ([871ac8e](https://github.com/Esposter/Esposter/commit/871ac8ee8da657ae7f1f27b91e3acca139f1621e))
...
* use pnpm deploy ([5b35497](https://github.com/Esposter/Esposter/commit/5b354973725d8f41dffe269cc8afe07b8956a0c5))
...
* Add dev docker ([9c4e181](https://github.com/Esposter/Esposter/commit/9c4e18117cbf347d31bcc19bf98bc889659f4d4e))
...
* cleanup unused catalog ([f85a1ac](https://github.com/Esposter/Esposter/commit/f85a1acd9822ac96b916bfeed516dbf830b99714))
...
* Upgrade to vue-tsc 3 ([00af3e5](https://github.com/Esposter/Esposter/commit/00af3e5d2eff60f6f2d7acda491b5d2e48686b39))
...
* vue-phaserjs inject types ([c2f2584](https://github.com/Esposter/Esposter/commit/c2f25846a2e657da73e8633fa526a8119a1c36fb))
...
* Upgrade to nuxt 4 ([27cc810](https://github.com/Esposter/Esposter/commit/27cc81003bf3f0cae5fe397850c39b1ca7538bbc))
...
* don't use absolute path ([6b56335](https://github.com/Esposter/Esposter/commit/6b563358f29aaf5e1b3440dfe70b54a8972e6102))
...
* no longer require build info ([ca178cb](https://github.com/Esposter/Esposter/commit/ca178cbe05f91279724c7dbd027f97e1ae935fdc))
...
* revert back hosted base url ([6d2c270](https://github.com/Esposter/Esposter/commit/6d2c270104dc7e43a245607785ca3356a38e651f))
...
* some formatting/lint ([a4dd6d8](https://github.com/Esposter/Esposter/commit/a4dd6d8921ea0b0e6e38ebbf66cc308d20a9a99d))
...
* builds by updating corepack ([c5da933](https://github.com/Esposter/Esposter/commit/c5da9334ab1b2022a2293d3b08321eaf52e30176))

* directly use process cwd ([aa16467](https://github.com/Esposter/Esposter/commit/aa16467386aeb5e4ed301b9fa4ec34d88b0e66b7))
...
* setup pnpm via official installation ([b313e4d](https://github.com/Esposter/Esposter/commit/b313e4d9571d388798eb883f73e563384cf401ab))

* update rollup ([03bf8c7](https://github.com/Esposter/Esposter/commit/03bf8c73aac066bd3d6620ae0dc1e97b54aeecb4))
...
* typescript ver ([e1b7fed](https://github.com/Esposter/Esposter/commit/e1b7fed6ddff8feab61dbe348b29b859332655ca))
...
* should run build first actually ([b9a0d6a](https://github.com/Esposter/Esposter/commit/b9a0d6ac44000667bcef02306233eda00a4766a8))
...
* remove comment in renovate ([cc3086b](https://github.com/Esposter/Esposter/commit/cc3086be8a261cfe71d19fee03dd8f57dfd349ac))
...
* gitignore ([5061160](https://github.com/Esposter/Esposter/commit/5061160f98a99736d9b4389059e81e733ff952c1))
...
- just use lerna for changelog ([8a1e503](https://github.com/Esposter/Esposter/commit/8a1e503dda26af4cba51615d15c16aaa6cc8149e))
