...
import { MessageType, StandardMessageType, standardMessageTypeSchema } from "@/models/message/MessageType";
...
export class BaseMessageEntity<TType extends StandardMessageType = StandardMessageType> extends AzureEntity implements ItemEntityType<TType> {
    files: FileEntity[] = [];
    isEdited?: true;
    isForward?: true;
