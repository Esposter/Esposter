...
// - Bold  — emphasis. Combined with Cyan for the tag, and with Blue for a fast-route cache/snapshot HIT label
...
// - Dim   — routine auto-emitted metadata & absence only: the doctor note column and "none"/"n/a". Never dim a path,
//           A cache/snapshot hit, or other primary content — dim means "background noise you can skip".
export enum Color {
  Blue = "blue",
  Bold = "bold",
  Cyan = "cyan",
