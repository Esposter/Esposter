...
import { runDoctor } from "#src/services/cli/doctor/runDoctor";
...
export const doctorCommand: CommandDef = defineCommand({
  meta: { description: "Diagnose the os backend's prerequisites and report what's missing.", name: CommandType.Doctor },
  run: () => {
