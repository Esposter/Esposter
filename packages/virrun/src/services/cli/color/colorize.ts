...
// Call is a no-op in a pipe, under NO_COLOR, or inside vitest (which is why the format-function tests still assert
// Plain strings). Nest calls to combine styles: colorize(colorize(text, Color.Cyan), Color.Bold).
