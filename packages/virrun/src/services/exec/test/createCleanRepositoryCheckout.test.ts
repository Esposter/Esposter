...
// Clones the repo's committed HEAD into a fresh directory with NO node_modules/.nuxt/.virrun (all gitignored, so a clone
// Omits them). The cache-layer bench needs this as its source: a `SourceType.Directory` run over the live repo installs into
