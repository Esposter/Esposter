...
// Name of the in-temp directory the getWslNativeCacheRoot mock points at on win32 (joined under os.tmpdir() by the
// Consumer).
export const TEST_WSL_CACHE_DIRECTORY_NAME = "a";
