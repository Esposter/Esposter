...
// Can't be stat'd mid-walk contributes 0 rather than aborting, and an absent directory or a directory vanishing mid-walk
...
export const computeDirectoryByteSize = (directory: string): number =>
  getResult(() => {
    let total = 0;
