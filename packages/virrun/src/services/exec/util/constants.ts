...
// Cap on the interactive-login capture (readWslLoginEnvironment) and the test gate that probes the same shell: a blocking rc/profile (a prompt, a hung version-manager hook) would
