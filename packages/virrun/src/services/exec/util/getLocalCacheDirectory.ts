...
// Results (readWslEnvironmentCache) must live here to avoid a circular "resolve the cache directory by spawning the
// Very probe the cache exists to skip". On non-win32 it coincides with getGlobalCacheDirectory; only the win32 WSL
