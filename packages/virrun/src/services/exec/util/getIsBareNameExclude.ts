...
// String: the matcher (isExcludedPath), the mirror's rebuild trigger (createWslSourceMirrorSync — a bare name is the
...
export const getIsBareNameExclude = (exclude: string): boolean => !exclude.includes("/");
