...
// As a source-tree path. node_modules itself never appears in a plan — `checkIsUnderSnapshotLower` masks every path
// With a `node_modules` segment out of write-back structurally — so there is nothing else to test.
