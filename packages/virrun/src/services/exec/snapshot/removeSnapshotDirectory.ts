...
export const removeSnapshotDirectory = (directory: string, timeoutMs: number = WSL_WORK_TIMEOUT_MS): void => {
  ...
  if (existsSync(directory) && lstatSync(directory).isDirectory()) makeTraversable(directory);
