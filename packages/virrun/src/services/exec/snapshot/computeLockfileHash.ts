...
// Lockfile. The stat guard keeps the cache honest if the
...
// So the key is identical whether virrun runs from the repo root or a subpackage
// (apps/web/content/docs/virrun/snapshot-and-fork.md). A missing lockfile throws (via resolveWorkspaceRoot) rather
// Than hashing "" and colliding every lockless repo onto one entry.
