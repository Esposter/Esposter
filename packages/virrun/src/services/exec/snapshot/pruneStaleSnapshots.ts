...
// Only the current lockfile hash's directory is reused by THIS run, so evict every superseded `snapshots/<hash>` —
// Sparing leased ones, detached, best-effort (pruneSupersededEntries).
