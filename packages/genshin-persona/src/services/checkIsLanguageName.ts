...
// Same way; this one cannot check the name against the package, which no hook path loads, so it checks the shape
// And lets `readRoster` fall back for a well-formed name the package does not answer in
