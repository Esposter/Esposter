...
describe(getSessionStartOutput, () => {
  ...
  // The remarks are what the plugin says about the session rather than the character, so they sit under the note and
  // Above the greeting, and reach the person alone
