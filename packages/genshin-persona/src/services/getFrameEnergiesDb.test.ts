...
describe(getFrameEnergiesDb, () => {
  ...
  test("reads one energy per hop, loud over the tone and floored over the silence after it", () => {
    ...
    const energiesDb = getFrameEnergiesDb({ sampleRate: VOICE_SAMPLE_RATE, samples: tone });
