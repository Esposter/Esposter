...
// The measured voice per character, generated by the repository's voice match benchmark and never edited by hand
export const PERSONA_VOICES_DIRECTORY: string = join(import.meta.dirname, "..", "generated", "personaVoices");
