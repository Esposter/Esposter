...
// What a hook sends to be spoken or warmed: the character the session speaks as, with the reference the card or the generated map
// Names for them, the dub the `voice` verb chose, and the volume as set
