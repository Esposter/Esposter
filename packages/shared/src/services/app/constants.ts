...
// Into config evaluation. `MEGABYTE` is unexported: it is the derivation step between the two units that do
// Have consumers, and an exported constant nobody imports is public surface this package would owe forever
