import type { CellState } from "@/models/resource/file/CellState";

import { CellMode } from "@/models/resource/file/CellMode";

export const useCellStore = defineStore("resource/file/cell", () => {
