...
ALTER TABLE "invites" ADD CONSTRAINT "invites_roomId_users_id_fk" FOREIGN KEY ("roomId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
