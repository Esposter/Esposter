...
flowchart LR
  ...
  LK -->|"GainNode gain + VA gate"| MP["MicrophoneProcessor<br/>(LiveKit audio TrackProcessor)"]
...
| `packages/app/app/models/message/room/call/MicrophoneProcessor.ts`         | Web Audio gain + voice-activity gate (LiveKit audio TrackProcessor)                |
