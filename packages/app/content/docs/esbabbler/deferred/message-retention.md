...
description: Deferred — per-room message pruning by age.
---
...
**Revisit when:** Azure Table storage cost becomes material, or a room/compliance requirement demands time-bounded retention.
