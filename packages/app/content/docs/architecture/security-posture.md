...
This page covers the **app**. The Azure estate's posture — network exposure, managed identities, key handling — is owned by the [infrastructure optimization review](/docs/infra/cost-and-security-posture).
