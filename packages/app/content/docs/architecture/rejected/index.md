...
- [Spec frameworks](/docs/architecture/rejected/spec-frameworks) — the proposal/as-built/validator loop already exists here, and `docs.test.ts` checks more than a spec CLI does
