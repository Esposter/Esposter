...
- [notification consolidation](/docs/proposals/refactors/notification-consolidation) — collapse four notification systems into one typed event, one Function and a per-type channel policy.
