...
2. **Explorer shell** — `/resource-explorer` Home (search + quick-create + recents), `/resource-explorer/all` list, `/resource-explorer/create[/type]` gallery + form, `/resource-explorer/[id]/[[blade]]` two-flex-box page, `useResource(id)`, `/view/[type]/[id]` public dispatch.
