...
- Response modes ([/docs/platform/survey-response-modes](/docs/platform/survey-response-modes)) extends this same `settings` object. There is one settings section, not one per feature.
