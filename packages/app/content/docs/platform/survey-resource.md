...
- `SurveyResponseEntity` (Azure Table, partitionKey = survey resource id) holds respondent answers plus the opaque `inviteToken` that joins a response back to a program invite.
