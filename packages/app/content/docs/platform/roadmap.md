...
No open work. Storage quotas shipped — see [storage quotas](/docs/platform/storage-quotas). The tracked Azure-portal-parity backlog is clear; new ideas start as a [proposal](/docs/proposals) and get a prioritized checkbox here.
