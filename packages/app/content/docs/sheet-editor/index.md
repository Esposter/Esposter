...
- **Formatted cells** — a boolean, date or number column renders through its `format`, and global search matches that rendered text while sorting stays on the underlying value. See [cell formatting](/docs/sheet-editor/cell-formatting).
