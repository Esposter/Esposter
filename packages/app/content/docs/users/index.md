...
- **Settings** — an introduction card plus a sidebar of sections: General (the profile card), Linked Accounts, and Sessions. Name and biography save through `user.updateUser` (biography length enforced by the users schema).
