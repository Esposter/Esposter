...
// The hand-written markdown of the repo: the root set, the agent tree, one README per package, the docs site and
// The skills. Generated markdown (CHANGELOG, the TypeDoc output under `public/`) is nobody's to edit, and
