import { generateTmxProperties } from "@/scripts/tiled/generateTmxProperties";
...
// If that's the case, please comment out the below generation scripts
// and run generatePropertyTypes first to bootstrap the required metadata typescript enum files
