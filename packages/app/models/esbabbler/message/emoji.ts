...
export const messageEmojiMetadataSchema = z
  .object({ emojiTag: z.string(), userIds: z.array(selectUserSchema.shape.id) })
  .merge(messageMetadataSchema) satisfies z.ZodType<MessageEmojiMetadataEntity>;
