...
export const ChancemakerUpgradeMap = {
  [ChancemakerUpgradeId["Lucky Horseshoe"]]: {
    description: `${pluralize(Target.Chancemaker)} are **twice** as efficient.`,
...
export const ChancemakerUpgrades: ReadonlySet<(typeof ChancemakerUpgradeMap)[keyof typeof ChancemakerUpgradeMap]> =
  new Set(Object.values(ChancemakerUpgradeMap));
