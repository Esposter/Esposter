...
export const AlchemyLabUpgradeMap = {
  [AlchemyLabUpgradeId.Antimony]: {
    description: `${pluralize(Target["Alchemy Lab"])} are **twice** as efficient.`,
...
export const AlchemyLabUpgrades: ReadonlySet<(typeof AlchemyLabUpgradeMap)[keyof typeof AlchemyLabUpgradeMap]> =
  new Set(Object.values(AlchemyLabUpgradeMap));
