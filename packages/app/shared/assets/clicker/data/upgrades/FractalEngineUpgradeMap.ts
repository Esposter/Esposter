...
export const FractalEngineUpgradeMap = {
  [FractalEngineUpgradeId.Metabakeries]: {
    description: `${plural(Target["Fractal Engine"])} are **twice** as efficient.`,
...
export const FractalEngineUpgrades: ReadonlySet<(typeof FractalEngineUpgradeMap)[keyof typeof FractalEngineUpgradeMap]> = new Set(
  Object.values(FractalEngineUpgradeMap),
);
