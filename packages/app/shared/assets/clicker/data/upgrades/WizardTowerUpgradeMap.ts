...
export const WizardTowerUpgradeMap = {
  [WizardTowerUpgradeId["Pointier Hats"]]: {
    description: `${plural(Target["Wizard Tower"])} are **twice** as efficient.`,
...
export const WizardTowerUpgrades: ReadonlySet<(typeof WizardTowerUpgradeMap)[keyof typeof WizardTowerUpgradeMap]> = new Set(
  Object.values(WizardTowerUpgradeMap),
);
