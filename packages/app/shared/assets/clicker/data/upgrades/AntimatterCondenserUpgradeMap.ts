...
export const AntimatterCondenserUpgradeMap = {
  [AntimatterCondenserUpgradeId["Sugar Bosons"]]: {
    description: `${pluralize(Target["Antimatter Condenser"])} are **twice** as efficient.`,
...
export const AntimatterCondenserUpgrades: ReadonlySet<
  (typeof AntimatterCondenserUpgradeMap)[keyof typeof AntimatterCondenserUpgradeMap]
> = new Set(Object.values(AntimatterCondenserUpgradeMap));
