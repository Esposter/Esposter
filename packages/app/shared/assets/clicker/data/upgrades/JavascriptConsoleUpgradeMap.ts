...
export const JavascriptConsoleUpgradeMap = {
  [JavascriptConsoleUpgradeId.Emscripten]: {
    description: `${pluralize(Target["Javascript Console"])} are **twice** as efficient.`,
...
export const JavascriptConsoleUpgrades: ReadonlySet<
  (typeof JavascriptConsoleUpgradeMap)[keyof typeof JavascriptConsoleUpgradeMap]
> = new Set(Object.values(JavascriptConsoleUpgradeMap));
