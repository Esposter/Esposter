...
export const TimeMachineUpgradeMap = {
  [TimeMachineUpgradeId["Flux Capacitors"]]: {
    description: `${plural(Target["Time Machine"])} are **twice** as efficient.`,
...
export const TimeMachineUpgrades: ReadonlySet<(typeof TimeMachineUpgradeMap)[keyof typeof TimeMachineUpgradeMap]> = new Set(
  Object.values(TimeMachineUpgradeMap),
);
