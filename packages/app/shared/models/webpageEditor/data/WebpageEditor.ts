...
import { createUniqueArraySchema, css, html } from "@esposter/shared";
import { z } from "zod";
        ...
        <body>
          <header class="header-banner">
            <div class="container-width">
              ...
              <div class="sub-lead-title">
                All text blocks could be edited easily with double clicking on it. You can create new text blocks with
                the command from the left panel
              </div>
          ...
          <section class="blk-sect">
            <div class="container-width">
              ...
              <div class="blk-desc">
                Each element in HTML page could be seen as a block. On the left panel you could find different kind of
                blocks that you can create, move and style
              </div>
