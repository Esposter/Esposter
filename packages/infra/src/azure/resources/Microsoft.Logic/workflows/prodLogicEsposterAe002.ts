      ...
      actions: {
        Start_Function_App: {
          inputs: {
            ...
            method: "post",
            path: "/subscriptions/@{encodeURIComponent('764658ba-01da-43fa-9f26-ffa4ada33ebb')}/resourcegroups/@{encodeURIComponent('prod-rg-esposter-ae-001')}/providers/Microsoft.Web/sites/@{encodeURIComponent('prod-func-esposter-001')}/start",
            queries: {
