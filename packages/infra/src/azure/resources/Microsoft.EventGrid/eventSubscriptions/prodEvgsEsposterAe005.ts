...
const eventSubscriptionName = "prod-evgs-esposter-ae-005";

export const prodEvgsEsposterAe005: azure_native.eventgrid.EventSubscription =
  new azure_native.eventgrid.EventSubscription(
    eventSubscriptionName,
    {
      ...
      destination: {
        ...
        resourceId: pulumi.interpolate`${prodFuncEsposter001.id}/functions/${AzureFunction.ProcessThreadReplyNotification}`,
      },
