...
const eventSubscriptionName = "dev-evgs-esposter-ae-005";

export const devEvgsEsposterAe005: azure_native.eventgrid.EventSubscription =
  new azure_native.eventgrid.EventSubscription(
    eventSubscriptionName,
    {
      ...
      destination: {
        ...
        resourceId: pulumi.interpolate`${devFuncEsposter001.id}/functions/${AzureFunction.ProcessThreadReplyNotification}`,
      },
      eventDeliverySchema: azure_native.eventgrid.EventDeliverySchema.EventGridSchema,
      eventSubscriptionName,
      filter: {
        enableAdvancedFilteringOnArrays: true,
        includedEventTypes: [AzureFunction.ProcessThreadReplyNotification],
        subjectBeginsWith: "",
        subjectEndsWith: "",
      },
