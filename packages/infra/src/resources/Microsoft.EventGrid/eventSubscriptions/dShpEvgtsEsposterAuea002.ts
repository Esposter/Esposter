...
export const dShpEvgtsEsposterAuea002: azure_native.eventgrid.EventSubscription =
  new azure_native.eventgrid.EventSubscription(
    "d-shp-evgts-esposter-auea-002",
    {
      destination: {
      ...
      eventSubscriptionName: "d-shp-evgts-esposter-auea-002",
      filter: {
