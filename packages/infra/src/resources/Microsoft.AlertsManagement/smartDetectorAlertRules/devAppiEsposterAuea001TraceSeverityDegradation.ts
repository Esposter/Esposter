...
const alertRuleName = "Trace Severity Degradation - dev-appi-esposter-auea-001";

export const devAppiEsposterAuea001TraceSeverityDegradation: azure_native.alertsmanagement.SmartDetectorAlertRule =
