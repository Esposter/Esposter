...
const alertRuleName = "Dependency Latency Degradation - dev-appi-esposter-ae-001";

export const devAppiEsposterAe001DependencyLatencyDegradation: azure_native.alertsmanagement.SmartDetectorAlertRule =
