...
const alertRuleName = "Response Latency Degradation - prod-appi-esposter-ae-001";

export const prodAppiEsposterAe001ResponseLatencyDegradation: azure_native.alertsmanagement.SmartDetectorAlertRule =
