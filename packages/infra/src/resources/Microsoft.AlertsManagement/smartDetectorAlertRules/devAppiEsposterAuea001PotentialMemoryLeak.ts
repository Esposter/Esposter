...
const alertRuleName = "Potential Memory Leak - dev-appi-esposter-auea-001";

export const devAppiEsposterAuea001PotentialMemoryLeak: azure_native.alertsmanagement.SmartDetectorAlertRule =
