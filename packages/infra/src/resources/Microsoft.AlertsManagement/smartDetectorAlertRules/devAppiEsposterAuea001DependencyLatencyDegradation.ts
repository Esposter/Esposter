...
const alertRuleName = "Dependency Latency Degradation - dev-appi-esposter-auea-001";

export const devAppiEsposterAuea001DependencyLatencyDegradation: azure_native.alertsmanagement.SmartDetectorAlertRule =
