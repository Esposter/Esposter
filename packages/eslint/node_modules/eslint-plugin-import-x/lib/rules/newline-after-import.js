...
function isExportNameClass(node) {
    ...
    return (node.type === 'ExportNamedDeclaration' &&
        ((_a = node.declaration) === null || _a === void 0 ? void 0 : _a.type) === 'ClassDeclaration');
}
module.exports = (0, utils_1.createRule)({
    ...
    create(context) {
        let level = 0;
        const requireCalls = [];
        const options = Object.assign({ count: 1, exactCount: false, considerComments: false }, context.options[0]);
        ...
        return {
            ...
            'Program:exit'(node) {
                ...
                const scopeBody = getScopeBody((0, utils_1.getScope)(context, node));
