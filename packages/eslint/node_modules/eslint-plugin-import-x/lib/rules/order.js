...
function reverse(array) {
    return array
        .map(function (v) {
        return Object.assign(Object.assign({}, v), { rank: -v.rank });
    })
        .reverse();
}
...
function registerNode(context, importEntry, ranks, imported, excludedImportTypes) {
    ...
    if (rank !== -1) {
        imported.push(Object.assign(Object.assign({}, importEntry), { rank }));
    }
}
function getRequireBlock(node) {
    ...
    if (((_a = n.parent) === null || _a === void 0 ? void 0 : _a.type) === 'VariableDeclarator' &&
        ((_b = n.parent.parent) === null || _b === void 0 ? void 0 : _b.type) === 'VariableDeclaration' &&
        ((_c = n.parent.parent.parent) === null || _c === void 0 ? void 0 : _c.type) === 'Program') {
...
function convertPathGroupsForRanks(pathGroups) {
    ...
    const transformed = pathGroups.map((pathGroup, index) => {
        ...
        return Object.assign(Object.assign({}, pathGroup), { position });
    });
    let maxPosition = 1;
