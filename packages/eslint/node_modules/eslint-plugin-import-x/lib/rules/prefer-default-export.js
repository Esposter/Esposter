...
module.exports = (0, utils_1.createRule)({
    ...
    create(context) {
        ...
        function captureDeclaration(identifierOrPattern) {
            if ((identifierOrPattern === null || identifierOrPattern === void 0 ? void 0 : identifierOrPattern.type) === 'ObjectPattern') {
                for (const property of identifierOrPattern.properties) {
                    captureDeclaration(property.value);
                }
            }
            else if ((identifierOrPattern === null || identifierOrPattern === void 0 ? void 0 : identifierOrPattern.type) === 'ArrayPattern') {
