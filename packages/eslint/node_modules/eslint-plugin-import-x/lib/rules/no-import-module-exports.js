    ...
    create(context) {
        ...
        return {
            ...
            MemberExpression(node) {
                ...
                const isException = !!((_a = options.exceptions) === null || _a === void 0 ? void 0 : _a.some(glob => (0, minimatch_1.minimatch)(filename, glob)));
                if (isIdentifier &&
