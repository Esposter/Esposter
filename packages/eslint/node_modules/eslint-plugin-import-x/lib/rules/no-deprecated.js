        ...
        return {
            Program({ body }) {
                ...
                for (const node of body) {
                    ...
                    const moduleDeprecation = (_a = imports.doc) === null || _a === void 0 ? void 0 : _a.tags.find(t => t.title === 'deprecated');
                    if (moduleDeprecation) {
                        context.report(Object.assign({ node }, message(moduleDeprecation)));
                    }
                    ...
                    for (const im of node.specifiers) {
                        ...
                        context.report(Object.assign({ node: im }, message(deprecation)));
            ...
            Identifier(node) {
                ...
                context.report(Object.assign({ node }, message(deprecated.get(node.name))));
            },
            MemberExpression(dereference) {
                ...
                while (namespace instanceof utils_1.ExportMap &&
                    (node === null || node === void 0 ? void 0 : node.type) === 'MemberExpression') {
                    if (node.computed) {
                        return;
                    }
                    ...
                    if (deprecation) {
                        context.report(Object.assign({ node: node.property }, message(deprecation)));
                    }
