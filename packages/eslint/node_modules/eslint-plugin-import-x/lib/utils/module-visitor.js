...
exports.optionsSchema = exports.makeOptionsSchema = exports.moduleVisitor = void 0;
function moduleVisitor(visitor, options) {
    const ignore = options === null || options === void 0 ? void 0 : options.ignore;
    const amd = !!(options === null || options === void 0 ? void 0 : options.amd);
    const commonjs = !!(options === null || options === void 0 ? void 0 : options.commonjs);
