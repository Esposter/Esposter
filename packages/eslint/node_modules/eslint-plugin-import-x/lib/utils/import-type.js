...
exports.importType = exports.isScopedMain = exports.isScoped = exports.isExternalModuleMain = exports.isExternalModule = exports.isBuiltIn = exports.isAbsolute = void 0;
...
function isInternalRegexMatch(name, settings) {
    const internalScope = settings === null || settings === void 0 ? void 0 : settings['import-x/internal-regex'];
...
function isExternalPath(filepath, context) {
    ...
    const folders = (settings === null || settings === void 0 ? void 0 : settings['import-x/external-module-folders']) || [
        'node_modules',
    ];
