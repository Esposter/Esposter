...
| A `regression` or `reopened` finding matches no entry in `references/fixing-findings.md` | the cause is unrecorded and will be re-shipped   | append it there in the same round                               |
