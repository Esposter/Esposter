...
## 1. `.agents/` is never excluded from a review window
...
| -------------------------------------------------------------------------------- | ------------------------------------------------------ | ---------------------------------------------------------------------------------------------- |
| Any `stats.dropped*` non-zero, or `returned no usable candidates`                | A phase degraded and territory went unread             | Fix the cause in the script; pin it with a test in `.agents/workflows/code-review/`            |
