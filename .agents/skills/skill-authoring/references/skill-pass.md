...
- **A citation of a heading from another skill**, or of a heading its own `SKILL.md` no longer has (`SKILL.md`'s "Heading"), fails `scripts/src/workspace/citations.test.ts`. Repoint it at the page.
