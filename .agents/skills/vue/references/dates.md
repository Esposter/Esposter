...
- **A plain date is its ISO date with `time-zone="UTC"`** — a calendar's day names no instant, and west of Greenwich its UTC midnight falls on the reader's previous day.
