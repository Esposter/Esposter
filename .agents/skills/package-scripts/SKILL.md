...
| `pnpm ai:sweep:constant-scope`             | `pnpm -C scripts run ai:sweep:constant-scope`                             | One sweep find recipe, as a tested script rather than a ledger code block (`sweeps` skill). One `sweep:*` per scan.                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
