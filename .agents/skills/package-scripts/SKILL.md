...
| `pnpm build`                               | `virrun -- pnpm --filter "@esposter/web..." build`  | The app and everything it imports, topologically — one closure, not a chain that names the library build first.                         |
