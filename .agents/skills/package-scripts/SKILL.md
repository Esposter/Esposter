...
| `pnpm coverage`                            | `vitest run --coverage` (no virrun)                                       | Root-only (packages have no `coverage` script). CI does not call it — the shards run `vitest run --coverage --shard=i/n --reporter=blob` and merge with `--merge-reports`.                                                                                                                                                                                                                                                                                                                                                                                           |
