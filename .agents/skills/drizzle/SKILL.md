...
- **Pass `schema: messageSchema`** for all message-feature tables (chat messages, webhooks, moderation logs, room filters, etc.) to group them under the `message` Postgres schema.
