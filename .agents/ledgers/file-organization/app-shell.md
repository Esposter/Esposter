...
| `app/composables`           | 2026-09-14 | sole-consumer subfolders                                                                        |
| `app/store`                 | 2026-09-14 | a store's file is named for its domain, so the filename never matches its `use*Store` export    |
