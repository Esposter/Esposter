...
| Unit                        | Swept               | Notes                                                                                           |
| --------------------------- | ------------------- | ----------------------------------------------------------------------------------------------- |
| `app/services`              | 2026-09-22 · Opus 5 | a file is named for its export, and a second map is a second file                               |
...
| `app/composables`           | 2026-09-22 · Opus 5 | sole-consumer subfolders                                                                        |
| `app/store`                 | 2026-09-22 · Opus 5 | a store's file is named for its domain, so the filename never matches its `use*Store` export    |
