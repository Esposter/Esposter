...
| Unit                                                           | Swept                 | Notes                                                                              |
| -------------------------------------------------------------- | --------------------- | ---------------------------------------------------------------------------------- |
| `architecture/*.md`                                            | 2026-09-25 · Opus 5.5 |                                                                                    |
| `resource/*.md`                                                | 2026-09-25 · Opus 5.5 | every area index carries a `Shipped log`, one line per program of work             |
| `esbabbler/*.md`, `esbabbler/calls/`                           | 2026-09-25 · Opus 5.5 | the widest area by some margin                                                     |
| `virrun/*.md`                                                  | 2026-09-25 · Opus 5.5 | bench figures belong to the artifacts that hold them, never to prose               |
| `resource/sheet/`, `infra/`                                    | 2026-09-25 · Opus 5.5 | `eventgrid-dead-letter` keeps two diagrams: a delivery path and an event lifecycle |
| `clicker/`, `dungeons/`, `post/`                               | 2026-09-25 · Opus 5.5 | split from `user/` to fit a review window                                          |
