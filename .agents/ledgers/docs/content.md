...
| `resource/*.md`                                                | 2026-09-06 | every area index carries a `Shipped log`, one line per program of work             |
...
| `resource/sheet/`, `infra/`                                    | 2026-09-06 | `eventgrid-dead-letter` keeps two diagrams: a delivery path and an event lifecycle |
| `clicker/`, `dungeons/`, `post/`                               | 2026-09-06 | split from `user/` to fit a review window                                          |
| `user/`                                                        | 2026-09-06 |                                                                                    |
| `vue-phaserjs/`, `achievement/`, `fluid-simulator/`, `anime/`  | 2026-09-06 |                                                                                    |
