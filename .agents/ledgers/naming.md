...
| `app/shared/models/db/message`                                         | —          | the input schemas every message router imports                                                                                                                                                                  |
| `app/shared/models/db` — `room`, `role`, `moderation`, `webhook`, …    | —          | the room family, plus `roomCategory` and `roomEmoji`                                                                                                                                                            |
