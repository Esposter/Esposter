...
| Unit                                                                                                                     | Swept | Notes                                                                   |
| ------------------------------------------------------------------------------------------------------------------------ | ----- | ----------------------------------------------------------------------- |
| `app/store` root files (`alert`, `cache`, `clipboard`, `colors`, `layout`, `navigationTrail`, `notification`, `storage`) | —     | the cross-cutting stores every product touches                          |
...
| `app/store/post`, `app/store/user`, `app/store/survey`, `app/store/achievement`                                          | —     |                                                                         |
