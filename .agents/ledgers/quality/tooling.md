...
| `scripts/src/models`                                           | 2026-09-25 · Opus 5.5 | one type per file, no logic                                                                   |
| `scripts/src/workspace`                                        | 2026-09-25 · Opus 5.5 | the enforcers, not the tooling they hold                                                      |
| `scripts/src` — the entrypoints                                | 2026-09-25 · Opus 5.5 | `citations`, `coderabbit`, `crossOS`, `dependencyGraph`, `refreshLockfile`, `sweeps`          |
...
| `apps/web/configuration`                                       | 2026-09-25 · Opus 5.5 | the relative imports are the pre-alias config exception; the splash table is generator output |
| the app's root config files                                    | 2026-09-25 · Opus 5.5 |                                                                                               |
| `content/docs` — the two suites                                | 2026-09-25 · Opus 5.5 | the enforcers, not the pages                                                                  |
| `content/docs` — `resource`                                    | 2026-09-25 · Opus 5.5 |                                                                                               |
| `content/docs` — `esbabbler`                                   | 2026-09-25 · Opus 5.5 |                                                                                               |
| `content/docs` — `architecture`                                | 2026-09-25 · Opus 5.5 |                                                                                               |
| `content/docs` — `virrun`                                      | 2026-09-25 · Opus 5.5 | `wsl.exe` in prose is the command, not a constant the code should have carried                |
| `content/docs` — the product areas                             | 2026-09-25 · Opus 5.5 |                                                                                               |
| `content/docs` — the rest                                      | 2026-09-25 · Opus 5.5 | `proposals`, `infra`, `users`, `achievements`, the root index                                 |
