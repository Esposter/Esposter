...
| Unit                                                                               | Swept                 | Notes                                                                                                                                          |
| ---------------------------------------------------------------------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| `app/store` — the rest                                                             | 2026-09-25 · Opus 5.5 | the root stores plus `achievement`, `clicker`, `dashboard`, `post`, `survey`, the editors                                                      |
| `app/composables` — `shared`, `data`                                               | 2026-09-25 · Opus 5.5 | `useQuery` / `useMutation` and the primitives around them                                                                                      |
| `app/composables` — the small product subdirs and the root files                   | 2026-09-25 · Opus 5.5 |                                                                                                                                                |
