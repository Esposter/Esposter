...
| `app/util`, `app/types`, `rules.config.ts`                                                                                        | —     |       |
...
| `services/{vuetify,styled,entity,zod,ajv,jsonSchema,compiler,shared,azure,cache,file}` + `util/date` + the matching `composables` | —     |       |
