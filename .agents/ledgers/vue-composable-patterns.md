...
| Unit                                                       | Swept                 | Notes                                                                             |
| ---------------------------------------------------------- | --------------------- | --------------------------------------------------------------------------------- |
| `app/composables/shared`                                   | 2026-09-25 · Opus 5.5 | the primitives themselves — a counter here is the implementation, not a violation |
...
| `app/store` as call sites                                  | 2026-09-22 · Opus 5   | shape is the `pinia` ledger's; this reads only the bookkeeping around an `await`  |
