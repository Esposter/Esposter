...
| `app/components/Message/Model/Message`                                                     | 2026-09-25 · Opus 5.5 | the densest surface; the message row and its variants                              |
| `app/components/Message/Model/Room/Settings/Type/Role`, `Webhook`, `Emoji`, `Member`       | 2026-09-25 · Opus 5.5 | the settings panels that own a list and an editor                                  |
| `app/components/Message/Model/Room/Settings/Type` — the rest                               | 2026-09-25 · Opus 5.5 | `Overview`, `Profile`, `AuditLog`, `WordFilter`, `Bans`, `Invite`, `Attachments`   |
| `app/components/Message/Model/Room/Settings` — the shell                                   | 2026-09-25 · Opus 5.5 | the dialog, its sidebar and the shared field                                       |
| `app/components/Message/Model/Room` — the rest                                             | 2026-09-25 · Opus 5.5 | `Create`, `DirectMessage`, `Emoji`, `Invite`, `List`, `Role` and the loose dialogs |
