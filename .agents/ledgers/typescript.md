...
| `app/composables/message/room` — the rest                                                       | —          |                                                                                                                                            |
| `app/composables/message/subscribables`                                                         | —          | the live-update handlers                                                                                                                   |
| `app/composables/message/message`, `moderation`, `draftsAndSent`                                | —          |                                                                                                                                            |
| `app/composables/message` — the composer family                                                 | —          | editor, composer, slashCommand, suggestion, mentions, emoji                                                                                |
| `app/composables/message` — the rest                                                            | —          | user, file, search, typing, thread, poll and the top level                                                                                 |
| `app/composables/resource/sheet/commands`                                                       | —          | one file per command                                                                                                                       |
| `app/composables/resource/sheet` — the rest                                                     | —          |                                                                                                                                            |
| `app/composables/resource/list`                                                                 | —          |                                                                                                                                            |
| `app/composables/resource` — the rest                                                           | —          | autosave, todoList, search, recycleBin and the top level                                                                                   |
| `app/composables/dungeons/scene`                                                                | —          |                                                                                                                                            |
| `app/composables/dungeons` — the rest                                                           | —          |                                                                                                                                            |
| `app/composables/shared`, `data`, `cache`                                                       | —          | the read and mutation primitives every other tree builds on                                                                                |
