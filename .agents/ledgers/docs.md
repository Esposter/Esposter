...
| Unit                                                           | Swept      | Notes                                                                                                                                                                                                                                                                                                                                                              |
| -------------------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `architecture/*.md`                                            | 2026-08-20 | resumed against the changed files: every history-shaped grep hit is a present-tense domain use (`no longer available`, `no longer joinable`), and the counts, MDC and fence greps are clean                                                                                                                                                                        |
| `platform/*.md`                                                | 2026-08-20 | the shipped log had drifted into paragraphs restating the feature pages listed above it on the same index — one line per program of work now, keeping the fact no page holds (the whole program added no Azure service). The heading is `Shipped log` on all eight areas, and `docs` says what belongs in one                                                      |
