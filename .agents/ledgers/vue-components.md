...
| Unit                                                                                       | Swept      | Notes                                                                                                                                                |
| ------------------------------------------------------------------------------------------ | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pages/` + `layouts/`                                                                      | 2026-09-22 | The page-decomposition rule: a page holding no element's state; a bound configuration literal is not a constant to relocate (`vue-page-composition`) |
| `Message/Model/Message`                                                                    | 2026-09-22 | the densest tree in the app                                                                                                                          |
| `Message/Model/Room`                                                                       | 2026-09-22 |                                                                                                                                                      |
| `Message/Model/User`                                                                       | 2026-09-22 |                                                                                                                                                      |
| `Message/Content/Call`                                                                     | 2026-09-22 |                                                                                                                                                      |
| `Message` — the rest                                                                       | 2026-09-22 |                                                                                                                                                      |
| `Resource/Sheet`                                                                           | 2026-09-22 |                                                                                                                                                      |
| `Resource` — the rest                                                                      | 2026-09-22 |                                                                                                                                                      |
| `Styled` + `App`                                                                           | 2026-09-22 | Primitives; produced the same-dependency-set carve-out (`vue`, `references/computed-extraction.md`)                                                  |
| `Dungeons`                                                                                 | 2026-09-22 | Grid-engine wrappers: shape is the engine's, same ground as the exclusion                                                                            |
| `Clicker`                                                                                  | 2026-09-22 | Already config-array driven                                                                                                                          |
| `Post`                                                                                     | 2026-09-22 |                                                                                                                                                      |
| `User`, `Achievement`, `Docs`, `Dashboard`, `Dataset`, `FlowchartEditor`, `RichTextEditor` | 2026-09-22 |                                                                                                                                                      |
| `Visual`, `Anime`, `About`, `Login`, `Nuxt`, `Transition`, `Fragment.vue`                  | 2026-09-22 | Canvas/animation effects — one concern each                                                                                                          |
| `app/composables`, `app/store`                                                             | 2026-09-22 | Computed rule only; a returned computed is the surface, not a find                                                                                   |
