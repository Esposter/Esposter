...
| Unit                                                             | Swept                 | Notes                                                     |
| ---------------------------------------------------------------- | --------------------- | --------------------------------------------------------- |
| `composables/data`                                               | 2026-09-24 · Opus 5.5 | one of the two pagination cores                           |
| `composables/shared`                                             | 2026-09-24 · Opus 5.5 | the other pagination core                                 |
| `services/{app,auth,login,google}`                               | 2026-09-24 · Opus 5.5 |                                                           |
| `services/{route,router,notification}`                           | 2026-09-24 · Opus 5.5 |                                                           |
| `services/trpc`                                                  | 2026-09-24 · Opus 5.5 |                                                           |
| `services/{azure,cache}`                                         | 2026-09-24 · Opus 5.5 |                                                           |
| `services/file`                                                  | 2026-09-24 · Opus 5.5 |                                                           |
...
| `components/{App,Nuxt,Transition}`, `Fragment.vue`, `App.vue`    | 2026-09-24 · Opus 5.5 |                                                           |
| `pages`, `layouts`                                               | 2026-09-24 · Opus 5.5 |                                                           |
| `plugins`, `middleware`                                          | 2026-09-24 · Opus 5.5 |                                                           |
