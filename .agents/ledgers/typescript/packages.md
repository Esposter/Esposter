...
| Unit                                                                           | Swept      | Notes |
| ------------------------------------------------------------------------------ | ---------- | ----- |
| `packages/db`, `packages/db-schema`                                            | 2026-09-21 |       |
| `packages/azure`, `packages/azure-mock`, `apps/functions`, `packages/db-mock`  | 2026-09-21 |       |
| `packages/virrun` — `services/exec`                                            | 2026-09-21 |       |
