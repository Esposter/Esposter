...
describe(getExternalId, () => {
  test("hashes a recorded stem to the id a track files its clip under", () => {
    ...
    expect(getExternalId("VO_friendship/VO_clorinde/vo_clorinde_character_idle_03", "Japanese")).toBe(
      16_092_681_363_853_473_498n,
    );
  });
});
