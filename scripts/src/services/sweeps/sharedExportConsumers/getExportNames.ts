// A modifier sits between `export` and the declaration keyword: `async` before a function, `declare` before any
// Of them in an ambient file, `abstract` before a class.
const EXPORT_REGEX =
