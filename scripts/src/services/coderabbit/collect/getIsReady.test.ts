...
describe(getIsReady, () => {
  test.each([
    [
      ...
      { fileCount: 5, fixCount: 1, isForced: false, isHeld: false, queueCommitCount: 1 },
      true,
    ],
    [
      "fixes parked and the queue is empty",
      { fileCount: 3, fixCount: 1, isForced: false, isHeld: false, queueCommitCount: 0 },
      false,
    ],
    [
    ...
    [
      ...
      { fileCount: WINDOW_FILL_TARGET - 1, fixCount: 0, isForced: false, isHeld: false, queueCommitCount: 4 },
      false,
    ],
    [
      "a short window the next commit cannot fit into",
      { fileCount: WINDOW_FILL_TARGET - 1, fixCount: 0, isForced: false, isHeld: true, queueCommitCount: 1 },
      true,
    ],
    [
      "held with nothing that fit",
      { fileCount: 0, fixCount: 0, isForced: false, isHeld: true, queueCommitCount: 0 },
      false,
    ],
    [
      "forced with a short queue",
      { fileCount: 1, fixCount: 0, isForced: true, isHeld: false, queueCommitCount: 1 },
      true,
    ],
    [
      "forced with fixes alone",
      { fileCount: 1, fixCount: 1, isForced: true, isHeld: false, queueCommitCount: 0 },
      true,
    ],
    [
      "forced with nothing at all",
      { fileCount: 0, fixCount: 0, isForced: true, isHeld: false, queueCommitCount: 0 },
      false,
    ],
  ])("%s", (_, input, expected) => {
